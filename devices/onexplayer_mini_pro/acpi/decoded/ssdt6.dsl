 ...
 *
 * Disassembly of ./encoded/ssdt6.dat, Sun Feb  4 20:48:39 2024
 *
...
DefinitionBlock ("", "SSDT", 1, "AMD", "AmdTable", 0x00000001)
{
    ...
    Scope (\_SB)
    {
        Name (PF0A, 0x98275C8C)
        Name (PF3A, 0x98275C99)
        Name (PF5A, 0x98275CBE)
        Name (PF6A, 0x98275D50)
        Name (PF9A, 0x98275D84)
        Name (PFBA, 0x98275E3C)
        Name (PFCA, 0x98275ED0)
        Name (PFDA, 0x98275F64)
