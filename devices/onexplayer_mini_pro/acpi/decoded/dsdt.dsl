 ...
 *
 * Disassembly of ./encoded/dsdt.dat, Sun Feb  4 20:48:39 2024
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00009363 (37731)
 *     Revision         0x02
 *     Checksum         0x29
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x93171000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x93175000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0x98271F18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x9825FD18, 0x0D)
