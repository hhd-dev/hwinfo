 ...
 *
 * Disassembly of ./encoded/ssdt8.dat, Wed Jul 10 13:32:12 2024
 *
...
DefinitionBlock ("", "SSDT", 2, "AMD", "CPMPMF", 0x00000001)
{
    ...
    Scope (\_SB)
    {
        Name (PF0A, 0x966FE00A)
        Name (PF3A, 0x966FE017)
        Name (PF5A, 0x966FE03C)
        Name (PF6A, 0x966FE0CE)
        Name (PF9A, 0x966FE102)
        Name (PFBA, 0x966FE1BA)
        Name (PFCA, 0x966FE24E)
        Name (PFDA, 0x966FE2E2)
