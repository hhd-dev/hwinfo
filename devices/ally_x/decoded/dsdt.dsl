 ...
 *
 * Disassembly of ./encoded/dsdt.dat, Wed Jul 10 13:32:12 2024
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00010D4E (68942)
 *     Revision         0x02
 *     Checksum         0x94
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Scope (_SB)
    {
        OperationRegion (ARTO, SystemMemory, ARTB, 0x06)
        Field (ARTO, AnyAcc, NoLock, Preserve)
        {
            ARTS,   32, 
            ACSS,   8, 
            ARCS,   8
    ...
    Scope (_SB)
    {
        ...
        Device (ATKD)
        {
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))
                {
                    ...
                    If ((IIA0 == 0x000600D2))
                    {
                        ...
                        RBUF = ^^PCI0.SBRG.EC0.REBC (0x51, 0x02)
                    ...
                    {
                        ISMI (0xA6)
                        Local0 = UFBS /* \_SB_.UFBS */
                        If ((Local0 == 0xFFFFFFFF))
                        {
                            Local0 = Zero
                        }
                        ElseIf ((Local0 == 0x0200))
                        {
                            Local0 = One
                        }
                        ElseIf ((Local0 == 0x0400))
                        {
                            Local0 = 0x02
                        }
                        ElseIf ((Local0 == 0x0800))
                        {
                            Local0 = 0x03
                        }
                        ElseIf ((Local0 == 0x0C00))
                        {
                            Local0 = 0x04
                        }
                        ...
                        ElseIf ((Local0 == 0x1400))
                        {
                            Local0 = 0x07
                        }
                        ElseIf ((Local0 == 0x1800))
                        {
                            Local0 = 0x08
                        }
                        ElseIf ((Local0 == 0x1C00))
                        {
                            Local0 = 0x09
                        }
                ...
                If ((Local0 == 0x53564544))
                {
                    ...
                    If ((IIA0 == 0x00120070))
                    {
                        ...
                        ^^PCI0.SBRG.EC0.WEBC (0x53, One, MPBE)
                        Return (One)
                    }
                    ...
                    If ((IIA0 == 0x000600D2))
                    {
                        ...
                        WBUF [Zero] = IIA1 /* \_SB_.ATKD.WMNB.IIA1 */
                        ^^PCI0.SBRG.EC0.WEBC (0x50, One, WBUF)
                        Return (One)
                    }
                ...
                If ((Local0 == 0x46424741))
                {
                    If ((IIA0 == 0x00010002))
                    {
                        SMIF = 0x08
                        ASMI (Zero)
                        M460 ("AsusAcpiSwSmiFunction_AsusFastbootStatus: %x\n", FBSS, Zero, Zero, Zero, Zero, Zero)
                        Return ((0x00010000 | FBSS))
                    }
                }
            ...
            Name (WQMO, Buffer (0x0929)
            {
                /* 0000 */  0x46, 0x4F, 0x4D, 0x42, 0x01, 0x00, 0x00, 0x00,  // FOMB....
                /* 0008 */  0x19, 0x09, 0x00, 0x00, 0x54, 0x2E, 0x00, 0x00,  // ....T...
                /* 0010 */  0x44, 0x53, 0x00, 0x01, 0x1A, 0x7D, 0xDA, 0x54,  // DS...}.T
                /* 0018 */  0x28, 0x4A, 0x96, 0x00, 0x01, 0x06, 0x18, 0x42,  // (J.....B
                /* 0020 */  0x10, 0x05, 0x10, 0x8A, 0x22, 0x8A, 0x42, 0x04,  // ....".B.
                ...
                /* 0170 */  0x9A, 0xC6, 0x39, 0xBD, 0x0D, 0x98, 0x60, 0x64,  // ..9...`d
                /* 0178 */  0x4B, 0x10, 0x7D, 0x40, 0x7A, 0xA9, 0xB2, 0xB1,  // K.}@z...
                ...
                /* 01E8 */  0x71, 0xA7, 0x4A, 0x41, 0x3C, 0xD5, 0xFF, 0xFF,  // q.JA<...
                /* 01F0 */  0xBB, 0x8A, 0xA6, 0x8A, 0x9E, 0x89, 0xA7, 0xCA,  // ........
                ...
                /* 0218 */  0x05, 0x39, 0x3C, 0x46, 0xF0, 0x48, 0xE9, 0x43,  // .9<F.H.C
                /* 0220 */  0x47, 0xE3, 0x42, 0x5C, 0x0E, 0x7C, 0xA6, 0x60,  // G.B\.|.`
                /* 0228 */  0xD8, 0xAF, 0x08, 0x47, 0xF3, 0x8A, 0x70, 0x86,  // ...G..p.
                /* 0230 */  0x4F, 0x11, 0x07, 0xF5, 0xCC, 0x61, 0x93, 0x3A,  // O....a.:
                /* 0238 */  0x4D, 0x4A, 0x85, 0xF5, 0x48, 0x39, 0xAC, 0xD1,  // MJ..H9..
                /* 0240 */  0xC2, 0x1E, 0xF0, 0xEB, 0x86, 0xCF, 0x2A, 0x9E,  // ......*.
                /* 0248 */  0x99, 0x31, 0xC2, 0x7A, 0xB4, 0x0E, 0xB4, 0x4E,  // .1.z...N
                /* 0250 */  0x5D, 0x26, 0x70, 0xB2, 0x80, 0x74, 0xCD, 0x38,  // ]&p..t.8
                /* 0258 */  0xA2, 0x63, 0x3A, 0x24, 0x26, 0xE8, 0x32, 0x41,  // .c:$&.2A
                /* 0260 */  0x21, 0x2C, 0x85, 0x42, 0x42, 0x20, 0x74, 0x24,  // !,.BB t$
                /* 0268 */  0xE0, 0xD1, 0xC1, 0x28, 0x88, 0x47, 0xE6, 0x58,  // ...(.G.X
                /* 0270 */  0x47, 0x02, 0xF4, 0x8B, 0xC8, 0xB3, 0xF6, 0x65,  // G......e
                /* 0278 */  0x06, 0x37, 0xD9, 0x87, 0x18, 0x06, 0x12, 0x8B,  // .7......
                /* 0280 */  0x5D, 0x0C, 0xF8, 0xC1, 0x00, 0xCC, 0xFF, 0x7F,  // ].......
                /* 0288 */  0x02, 0x76, 0x30, 0x00, 0x3C, 0x29, 0x74, 0x2A,  // .v0.<)t*
                /* 0290 */  0xD5, 0xE9, 0xC1, 0x00, 0x5C, 0x21, 0x0F, 0x06,  // ....\!..
                /* 0298 */  0x68, 0xA9, 0x40, 0x9A, 0x50, 0x8D, 0x07, 0x28,  // h.@.P..(
                /* 02A0 */  0xDD, 0x5A, 0x12, 0x58, 0xE4, 0xC1, 0x00, 0x25,  // .Z.X...%
                /* 02A8 */  0x8F, 0x42, 0xE2, 0x0E, 0x06, 0x28, 0x39, 0x70,  // .B...(9p
                /* 02B0 */  0x14, 0xC4, 0x23, 0x73, 0xD4, 0x83, 0x01, 0x7A,  // ..#s...z
                /* 02B8 */  0x9C, 0x09, 0x0E, 0xF2, 0x58, 0x8E, 0xE7, 0xC0,  // ....X...
                /* 02C0 */  0xDE, 0x6B, 0xCE, 0xE6, 0xA9, 0xC0, 0x43, 0x8F,  // .k....C.
                /* 02C8 */  0x13, 0x88, 0xCF, 0xC8, 0x50, 0xAF, 0x36, 0xA1,  // ....P.6.
                /* 02D0 */  0x9E, 0x0F, 0x7C, 0x2A, 0x32, 0xD8, 0x3B, 0x82,  // ..|*2.;.
                /* 02D8 */  0xA1, 0x1E, 0x0F, 0x62, 0x7A, 0x72, 0x2F, 0x5F,  // ...bzr/_
                /* 02E0 */  0x3E, 0x21, 0x18, 0x8D, 0x1F, 0x11, 0x80, 0xF3,  // >!......
                /* 02E8 */  0xFF, 0xFF, 0x88, 0x00, 0xAC, 0x9D, 0x6A, 0xB4,  // ......j.
                /* 02F0 */  0xAA, 0xF3, 0x88, 0x00, 0xAE, 0x48, 0xD7, 0x24,  // .....H.$
                /* 02F8 */  0xB4, 0x30, 0x20, 0x8D, 0xE3, 0x70, 0xFB, 0x3C,  // .0 ..p.<
                /* 0300 */  0xB3, 0x89, 0xC0, 0x92, 0x80, 0x74, 0x4D, 0xE2,  // .....tM.
                /* 0308 */  0x62, 0x28, 0x24, 0xE3, 0x88, 0x80, 0x0A, 0x7E,  // b($....~
                /* 0310 */  0x50, 0xA0, 0x20, 0x06, 0x74, 0xAA, 0x23, 0x02,  // P. .t.#.
                /* 0318 */  0xFA, 0x50, 0x64, 0xEF, 0x47, 0x02, 0x72, 0x27,  // .Pd.G.r'
                /* 0320 */  0x38, 0xB2, 0x93, 0x39, 0xB3, 0xF7, 0xB0, 0x93,  // 8..9....
                /* 0328 */  0x7D, 0x2B, 0xF0, 0x90, 0x7C, 0x45, 0x08, 0x13,  // }+..|E..
                /* 0330 */  0xEC, 0xC1, 0xC0, 0xE7, 0x31, 0x5F, 0xB8, 0x7C,  // ....1_.|
                /* 0338 */  0x5E, 0x02, 0x7C, 0x89, 0x18, 0x33, 0x2A, 0xF6,  // ^.|..3*.
                /* 0340 */  0x98, 0x29, 0x88, 0xC7, 0xEC, 0x9B, 0xDE, 0xFF,  // .)......
                /* 0348 */  0xFF, 0x98, 0xB1, 0x1F, 0x01, 0x4F, 0x17, 0x77,  // .....O.w
                /* 0350 */  0xC5, 0xF0, 0x59, 0x06, 0xB8, 0x9C, 0x99, 0x00,  // ..Y.....
                /* 0358 */  0x57, 0x5E, 0x25, 0xFA, 0xF4, 0x78, 0xB2, 0x00,  // W^%..x..
                /* 0360 */  0x57, 0xB8, 0xB3, 0x0C, 0x5A, 0x22, 0x90, 0x5C,  // W...Z".\
                /* 0368 */  0xDE, 0x99, 0x74, 0xA0, 0x33, 0x81, 0xCF, 0x31,  // ..t.3..1
                /* 0370 */  0x3E, 0xCB, 0xF0, 0xA3, 0x93, 0x45, 0x1D, 0x0B,  // >....E..
                /* 0378 */  0x50, 0x87, 0x0B, 0x83, 0x19, 0xC4, 0x23, 0x73,  // P.....#s
                /* 0380 */  0xC4, 0x63, 0x01, 0x7A, 0xC4, 0x3E, 0x0F, 0x3C,  // .c.z.>.<
                /* 0388 */  0x16, 0xF8, 0xB6, 0xE7, 0x13, 0x1D, 0xBB, 0xC7,  // ........
                /* 0390 */  0xF8, 0xCE, 0xC4, 0xCE, 0x85, 0x86, 0x7A, 0x35,  // ......z5
                /* 0398 */  0x88, 0xE4, 0x51, 0xBD, 0xF9, 0x19, 0xF5, 0x71,  // ..Q....q
                /* 03A0 */  0xE6, 0x3D, 0x06, 0x7B, 0x3C, 0x80, 0xF7, 0xFF,  // .=.{<...
                /* 03A8 */  0x3F, 0xC7, 0x00, 0x46, 0x5D, 0x2A, 0x7C, 0xA1,  // ?..F]*|.
                /* 03B0 */  0x3D, 0x1E, 0x80, 0x4B, 0xD4, 0x2A, 0x74, 0x3C,  // =..K.*t<
                /* 03B8 */  0xC0, 0x45, 0x5B, 0x8B, 0x26, 0x74, 0x66, 0xA7,  // .E[.&tf.
                /* 03C0 */  0xFB, 0x1C, 0xC3, 0x42, 0x9D, 0x63, 0x50, 0x77,  // ...B.cPw
                /* 03C8 */  0x5E, 0x47, 0x3A, 0x1E, 0xA0, 0x42, 0x1C, 0x0F,  // ^G:..B..
                /* 03D0 */  0x28, 0x88, 0xC7, 0xE5, 0x70, 0xC7, 0x03, 0xB4,  // (...p...
                /* 03D8 */  0xBC, 0xBB, 0x2D, 0x99, 0x98, 0x6F, 0x20, 0x9E,  // ..-..o .
                /* 03E0 */  0x50, 0x94, 0xA7, 0x82, 0xE7, 0x02, 0x7E, 0x8C,  // P.....~.
                /* 03E8 */  0xF1, 0xC1, 0xE0, 0x8D, 0xC9, 0x07, 0x84, 0xE7,  // ........
                /* 03F0 */  0x83, 0x57, 0x03, 0x0C, 0xD8, 0x69, 0xC5, 0x31,  // .W...i.1
                /* 03F8 */  0xC4, 0xAB, 0x0C, 0x70, 0xFC, 0xFF, 0xDF, 0x0D,  // ...p....
                /* 0400 */  0x58, 0x8A, 0xE1, 0xA1, 0x75, 0x1C, 0x1B, 0xC8,  // X...u...
                /* 0408 */  0xD0, 0x22, 0x9C, 0xDD, 0xF9, 0x79, 0x4A, 0xE0,  // ."...yJ.
                /* 0410 */  0x1D, 0xB7, 0x4F, 0x3B, 0xC0, 0xF9, 0x14, 0xE8,  // ..O;....
                /* 0418 */  0x93, 0x01, 0x0F, 0x3B, 0x24, 0x0A, 0xE2, 0x13,  // ...;$...
                /* 0420 */  0x82, 0x83, 0x5C, 0x53, 0xA1, 0x5C, 0x06, 0x30,  // ..\S.\.0
                /* 0428 */  0x47, 0x0F, 0xB0, 0x0F, 0xC4, 0x27, 0x32, 0x40,  // G....'2@
                /* 0430 */  0x94, 0x43, 0x89, 0x07, 0x1D, 0xFD, 0xFF, 0x8F,  // .C......
                /* 0438 */  0x1E, 0x60, 0xCA, 0x74, 0x22, 0x43, 0x2B, 0x3B,  // .`.t"C+;
                /* 0440 */  0x7A, 0x90, 0x51, 0x7A, 0x6A, 0x09, 0xAC, 0xE9,  // z.Qzj...
                /* 0448 */  0xE8, 0x81, 0x52, 0x43, 0x21, 0x3D, 0x47, 0x0F,  // ..RC!=G.
                /* 0450 */  0x94, 0x82, 0xEB, 0x30, 0x3F, 0xE8, 0xD0, 0x78,  // ...0?..x
                /* 0458 */  0x07, 0x1D, 0x28, 0x47, 0x0F, 0x78, 0xD7, 0x0E,  // ..(G.x..
                /* 0460 */  0xDC, 0xA1, 0x8A, 0x8D, 0xEB, 0x0C, 0x0D, 0x79,  // .......y
                /* 0468 */  0x68, 0x8F, 0x66, 0x3E, 0xF0, 0x04, 0xF6, 0xA5,  // h.f>....
                /* 0470 */  0x18, 0xF0, 0x7B, 0x38, 0xF7, 0x41, 0xD2, 0xA7,  // ..{8.A..
                /* 0478 */  0x6D, 0x7E, 0x23, 0x03, 0x1E, 0xFF, 0xFF, 0x9B,  // m~#.....
                /* 0480 */  0x05, 0x20, 0x48, 0xA8, 0x45, 0x87, 0x57, 0x47,  // . H.E.WG
                /* 0488 */  0xF0, 0xDF, 0x1C, 0x8F, 0xA8, 0xD6, 0x29, 0xE9,  // ......).
                /* 0490 */  0xEA, 0x08, 0xE7, 0x9E, 0xEA, 0x23, 0x01, 0x27,  // .....#.'
                /* 0498 */  0x33, 0x9C, 0x29, 0x0C, 0xE8, 0x74, 0x47, 0x02,  // 3.)..tG.
                /* 04A0 */  0xF4, 0x75, 0xC1, 0xE3, 0x39, 0x98, 0xC7, 0x8A,  // .u..9...
                /* 04A8 */  0x47, 0x0A, 0x8F, 0xE7, 0x5C, 0xDF, 0xD3, 0x02,  // G...\...
                /* 04B0 */  0x9D, 0x87, 0xCF, 0x48, 0x9E, 0x7C, 0xA8, 0x37,  // ...H.|.7
                /* 04B8 */  0x03, 0x0F, 0xCA, 0x40, 0xB1, 0x98, 0xF6, 0x23,  // ...@...#
                /* 04C0 */  0x20, 0xB9, 0x9E, 0xF9, 0x44, 0xC6, 0x4E, 0x16,  //  ...D.N.
                /* 04C8 */  0x80, 0x91, 0xFF, 0xFF, 0xED, 0x1D, 0xE0, 0x90,  // ........
                /* 04D0 */  0x4F, 0xA7, 0x5A, 0x95, 0x9E, 0x2C, 0xC0, 0xA5,  // O.Z..,..
                /* 04D8 */  0xF8, 0x32, 0x87, 0xCE, 0xBD, 0x16, 0x1D, 0x2C,  // .2.....,
                /* 04E0 */  0x0E, 0x09, 0x93, 0xF8, 0x64, 0x81, 0xCA, 0x4A,  // ....d..J
                /* 04E8 */  0xA1, 0x64, 0x27, 0x0B, 0x54, 0x96, 0x93, 0x05,  // .d'.T...
                /* 04F0 */  0x05, 0xF1, 0xB8, 0x7C, 0x7B, 0xC7, 0x8F, 0xDE,  // ...|{...
                /* 04F8 */  0x07, 0xDC, 0x57, 0x20, 0x76, 0x78, 0xF4, 0x88,  // ..W vx..
                /* 0500 */  0x60, 0xDC, 0x2A, 0xB0, 0xFF, 0xFF, 0x5B, 0x05,  // `.*...[.
                /* 0508 */  0x70, 0xBD, 0xCB, 0xE2, 0x2F, 0xFA, 0xBE, 0x11,  // p.../...
                /* 0510 */  0x3C, 0x73, 0xC3, 0x19, 0x19, 0xF0, 0x38, 0xD0,  // <s....8.
                /* 0518 */  0x01, 0x6F, 0x41, 0x97, 0x03, 0x94, 0x84, 0xCB,  // .oA.....
                /* 0520 */  0x01, 0x05, 0xF1, 0x79, 0x0B, 0x8E, 0xB8, 0x19,  // ...y....
                /* 0528 */  0x92, 0xAB, 0x01, 0x38, 0x2E, 0x09, 0xC6, 0xF0,  // ...8....
                /* 0530 */  0x6D, 0x86, 0x9F, 0xED, 0x80, 0xC3, 0xFF, 0xFF,  // m.......
                /* 0538 */  0x22, 0x02, 0x58, 0xD2, 0x6A, 0x51, 0xA9, 0xD3,  // ".X.jQ..
                /* 0540 */  0x8B, 0x08, 0xB8, 0xE2, 0x9C, 0x89, 0xD1, 0x67,  // .......g
                /* 0548 */  0x61, 0x1F, 0xE4, 0x8E, 0xEC, 0x2D, 0xD5, 0x04,  // a....-..
                /* 0550 */  0xBE, 0x2D, 0xF9, 0x4C, 0xCC, 0x85, 0x50, 0xE8,  // .-.L..P.
                /* 0558 */  0xF0, 0x0E, 0x37, 0xD4, 0xE1, 0x00, 0x2D, 0xE9,  // ..7...-.
                /* 0560 */  0x4E, 0x46, 0x8F, 0x3A, 0x06, 0x79, 0x28, 0xF0,  // NF.:.y(.
                /* 0568 */  0x8C, 0x5E, 0x2F, 0x82, 0x3C, 0xD4, 0xB1, 0xB1,  // .^/.<...
                /* 0570 */  0x9E, 0xC8, 0x8B, 0x00, 0x3B, 0x0C, 0x03, 0x96,  // ....;...
                /* 0578 */  0xFE, 0xFF, 0xE7, 0x02, 0x60, 0xE0, 0x51, 0xE6,  // ....`.Q.
                /* 0580 */  0x13, 0xF2, 0xB9, 0x00, 0x5C, 0xE2, 0x2F, 0x66,  // ....\./f
                /* 0588 */  0x68, 0x09, 0x40, 0x9A, 0xD3, 0x9B, 0xF7, 0x0B,  // h.@.....
                /* 0590 */  0xCF, 0xA3, 0x37, 0x0B, 0x7F, 0x76, 0xE4, 0x47,  // ..7..v.G
                /* 0598 */  0x7B, 0x93, 0xE8, 0x48, 0xE0, 0x73, 0x01, 0x8F,  // {..H.s..
                /* 05A0 */  0x7A, 0x2E, 0xA0, 0x20, 0x06, 0x74, 0x8E, 0x73,  // z.. .t.s
                /* 05A8 */  0x01, 0x5A, 0xC9, 0x8D, 0x8A, 0x0C, 0xF6, 0x48,  // .Z.....H
                /* 05B0 */  0xDF, 0x1C, 0x31, 0xD7, 0x46, 0x80, 0x1D, 0xFF,  // ..1.F...
                /* 05B8 */  0xFF, 0xDB, 0x18, 0x60, 0xCE, 0xA0, 0x4E, 0xAD,  // ...`..N.
                /* 05C0 */  0x47, 0x75, 0x90, 0x09, 0xB9, 0x8D, 0xA1, 0xCF,  // Gu......
                /* 05C8 */  0xE8, 0x9E, 0xC5, 0x79, 0x3C, 0xB6, 0xD4, 0x08,  // ...y<...
                /* 05D0 */  0x45, 0x82, 0xDC, 0xC6, 0x50, 0x11, 0x28, 0x74,  // E...P.(t
                /* 05D8 */  0x4A, 0xF7, 0x91, 0x80, 0xCB, 0x3E, 0x55, 0x50,  // J....>UP
                /* 05E0 */  0x10, 0x8F, 0xCB, 0x27, 0x68, 0xBC, 0x14, 0x10,  // ...'h...
                /* 05E8 */  0x5D, 0x00, 0x8E, 0xE5, 0xE1, 0xE8, 0x11, 0xCB,  // ].......
                /* 05F0 */  0x20, 0xE7, 0xFA, 0x12, 0xC0, 0xAE, 0x13, 0xC0,  //  .......
                /* 05F8 */  0x33, 0xCB, 0xA0, 0xD0, 0xC3, 0x30, 0xF2, 0xD3,  // 3....0..
                /* 0600 */  0x93, 0x11, 0x1F, 0x1C, 0x82, 0xBC, 0xD6, 0x78,  // .......x
                /* 0608 */  0xA6, 0x31, 0x1E, 0x6D, 0x9E, 0xDB, 0xCE, 0x0A,  // .1.m....
                /* 0610 */  0xFB, 0xFF, 0x3F, 0x83, 0x01, 0x86, 0x0E, 0x1D,  // ..?.....
                /* 0618 */  0xC0, 0xFD, 0xE4, 0x05, 0xB8, 0xB2, 0xE9, 0xD5,  // ........
                /* 0620 */  0xA3, 0xC6, 0x43, 0x07, 0xB8, 0x32, 0x1C, 0x89,  // ..C..2..
                /* 0628 */  0xC8, 0xFF, 0xFF, 0xD0, 0x81, 0x51, 0x02, 0xA4,  // .....Q..
                /* 0630 */  0xD9, 0x1E, 0xD1, 0x31, 0x1D, 0x12, 0xD3, 0x70,  // ...1...p
                /* 0638 */  0xE8, 0x40, 0xA5, 0x27, 0x51, 0xF2, 0x23, 0x01,  // .@.'Q.#.
                /* 0640 */  0x2A, 0xEB, 0x91, 0x80, 0x82, 0x18, 0xD0, 0x87,  // *.......
                /* 0648 */  0x0E, 0xC0, 0xC7, 0x75, 0x02, 0x58, 0x5C, 0x0E,  // ...u.X\.
                /* 0650 */  0x3D, 0x59, 0x1E, 0x7A, 0xB2, 0x14, 0xC4, 0x93,  // =Y.z....
                /* 0658 */  0x75, 0xA0, 0xC9, 0xA2, 0x2F, 0x10, 0xBE, 0x4B,  // u.../..K
                /* 0660 */  0x79, 0xB2, 0x98, 0x13, 0xC5, 0x3B, 0x2F, 0xEE,  // y....;/.
                /* 0668 */  0x56, 0x04, 0x78, 0xF9, 0xFF, 0xDF, 0x28, 0x80,  // V.x...(.
                /* 0670 */  0x8F, 0x44, 0xA7, 0x52, 0xAF, 0x86, 0x20, 0x93,  // .D.R.. .
                /* 0678 */  0x72, 0x2B, 0x42, 0x07, 0xBA, 0x51, 0x90, 0x21,  // r+B..Q.!
                /* 0680 */  0xBD, 0xB3, 0x1D, 0x12, 0x8B, 0x72, 0xA3, 0x40,  // .....r.@
                /* 0688 */  0x85, 0xA0, 0x50, 0x8C, 0x53, 0x01, 0x4A, 0xF8,  // ..P.S.J.
                /* 0690 */  0xAD, 0x88, 0x82, 0xF8, 0x56, 0x04, 0x38, 0x49,  // ....V.8I
                /* 0698 */  0x33, 0x28, 0xB4, 0x9E, 0x5B, 0x11, 0x94, 0x9B,  // 3(..[...
                /* 06A0 */  0x03, 0xF6, 0x5A, 0x04, 0x8C, 0xFF, 0xFF, 0xD7,  // ..Z.....
                /* 06A8 */  0x22, 0x80, 0x63, 0x12, 0x2D, 0x6A, 0x3D, 0x75,  // ".c.-j=u
                /* 06B0 */  0x00, 0x81, 0x39, 0x3D, 0xDA, 0x3D, 0x2E, 0xBF,  // ..9=.=..
                /* 06B8 */  0xDA, 0xB1, 0x53, 0x07, 0x70, 0xF9, 0xFF, 0x9F,  // ..S.p...
                /* 06C0 */  0x3A, 0x00, 0xFE, 0xFF, 0xFF, 0xEF, 0xA7, 0x40,  // :......@
                /* 06C8 */  0xDC, 0xA3, 0xC2, 0xBB, 0x1D, 0xC8, 0x02, 0xAC,  // ........
                /* 06D0 */  0x82, 0x1E, 0xC8, 0x2C, 0x19, 0x06, 0x25, 0x01,  // ...,..%.
                /* 06D8 */  0x42, 0x97, 0x72, 0x0F, 0x81, 0x8F, 0xD0, 0x73,  // B.r....s
                /* 06E0 */  0x6E, 0x1E, 0x5F, 0x17, 0x88, 0xD3, 0xF1, 0x49,  // n._....I
                /* 06E8 */  0xE3, 0x00, 0x98, 0xB4, 0xB1, 0xA1, 0x4E, 0x1C,  // ......N.
                /* 06F0 */  0x1E, 0xE4, 0xBB, 0x84, 0x6F, 0x1C, 0xBE, 0x9D,  // ....o...
                /* 06F8 */  0x19, 0x26, 0x81, 0xC7, 0xC6, 0xD0, 0xF8, 0x89,  // .&......
                /* 0700 */  0x00, 0x06, 0xE0, 0x21, 0x3E, 0x59, 0x7B, 0x10,  // ...!>Y{.
                /* 0708 */  0x9E, 0xD9, 0x41, 0x60, 0x4E, 0x26, 0xBE, 0x97,  // ..A`N&..
                /* 0710 */  0xB4, 0x7A, 0x24, 0x40, 0xB8, 0xBF, 0x11, 0xE8,  // .z$@....
                /* 0718 */  0x6C, 0xF2, 0x22, 0xF0, 0x04, 0x10, 0x23, 0x88,  // l."...#.
                /* 0720 */  0xAD, 0x09, 0xB0, 0x35, 0x79, 0x01, 0xF9, 0x34,  // ...5y..4
                /* 0728 */  0x10, 0xE5, 0x94, 0x02, 0xBD, 0xB9, 0x1B, 0xA5,  // ........
                /* 0730 */  0x39, 0x01, 0xC6, 0xA0, 0x10, 0x20, 0xB1, 0xDE,  // 9.... ..
                /* 0738 */  0x03, 0x6A, 0x03, 0x13, 0x54, 0xB0, 0x30, 0x41,  // .j..T.0A
                /* 0740 */  0x0C, 0xD5, 0xFE, 0x20, 0x88, 0xFC, 0x67, 0x80,  // ... ..g.
                /* 0748 */  0xAE, 0x19, 0x8E, 0x34, 0x1A, 0xD4, 0x69, 0x8E,  // ...4..i.
                /* 0750 */  0x8F, 0xE6, 0x54, 0x1F, 0x3E, 0x18, 0xC8, 0x43,  // ..T.>..C
                /* 0758 */  0x8A, 0x8F, 0xE0, 0x87, 0xEB, 0xDB, 0xB6, 0x09,  // ........
                /* 0760 */  0x1E, 0x1E, 0x7C, 0x86, 0x80, 0xE3, 0x1A, 0x50,  // ..|....P
                /* 0768 */  0x13, 0x3F, 0x44, 0xF6, 0xFF, 0xFF, 0xC9, 0x18,  // .?D.....
                /* 0770 */  0x8E, 0x0F, 0xD1, 0x87, 0x0A, 0x4F, 0xE0, 0x6D,  // .....O.m
                /* 0778 */  0xC0, 0x80, 0xEC, 0x10, 0x01, 0x7F, 0x3C, 0x86,  // ......<.
                /* 0780 */  0x7E, 0x8A, 0xF0, 0x35, 0xD6, 0x63, 0xD3, 0x20,  // ~..5.c. 
                /* 0788 */  0x50, 0x27, 0x0D, 0x3E, 0xCC, 0xD3, 0x8A, 0x19,  // P'.>....
                /* 0790 */  0xF2, 0x29, 0xE0, 0xB0, 0x98, 0xD8, 0xB3, 0x03,  // .)......
                /* 0798 */  0x1D, 0x0F, 0xF8, 0x15, 0x1F, 0x0D, 0x74, 0x79,  // ......ty
                /* 07A0 */  0x31, 0xB6, 0xCF, 0x2C, 0x8E, 0x70, 0x10, 0x81,  // 1..,.p..
                /* 07A8 */  0x02, 0x7A, 0x36, 0x3E, 0x43, 0xF8, 0x5E, 0xC0,  // .z6>C.^.
                /* 07B0 */  0x8E, 0x16, 0x5C, 0xD4, 0xD1, 0x02, 0x75, 0x68,  // ..\...uh
                /* 07B8 */  0xF0, 0x79, 0x81, 0x21, 0x3E, 0xCE, 0x18, 0xE2,  // .y.!>...
                /* 07C0 */  0xC9, 0x82, 0x1D, 0x07, 0xC1, 0x39, 0x12, 0x1F,  // .....9..
                /* 07C8 */  0x42, 0xE0, 0x83, 0xBC, 0xAC, 0x18, 0x22, 0x48,  // B....."H
                /* 07D0 */  0xF0, 0x67, 0x82, 0xD3, 0x61, 0x43, 0xC3, 0x10,  // .g..aC..
                /* 07D8 */  0x14, 0x39, 0x02, 0xD4, 0xB1, 0xC3, 0x23, 0xE0,  // .9....#.
                /* 07E0 */  0xE7, 0x84, 0x07, 0x12, 0x36, 0x82, 0x77, 0x12,  // ....6.w.
                /* 07E8 */  0x4F, 0xE2, 0x80, 0x7C, 0xB6, 0x30, 0x42, 0xEC,  // O..|.0B.
                /* 07F0 */  0x72, 0x8F, 0x18, 0x44, 0xF3, 0xF8, 0x74, 0x86,  // r..D..t.
                /* 07F8 */  0xC1, 0x8C, 0x09, 0x77, 0x62, 0xF0, 0x10, 0xF8,  // ...wb...
                /* 0800 */  0x00, 0x9E, 0x2D, 0xCE, 0xCF, 0x27, 0x94, 0x23,  // ..-..'.#
                /* 0808 */  0xF8, 0xFF, 0x9F, 0x15, 0x66, 0xC4, 0x7C, 0x4A,  // ....f.|J
                /* 0810 */  0xB8, 0x01, 0x60, 0x14, 0xDA, 0xF4, 0xA9, 0xD1,  // ..`.....
                /* 0818 */  0xA8, 0x55, 0x83, 0x32, 0x35, 0xCA, 0x34, 0xA8,  // .U.25.4.
                /* 0820 */  0xD5, 0xA7, 0x52, 0x63, 0xC6, 0xD0, 0x1F, 0xA7,  // ..Rc....
                /* 0828 */  0xD8, 0x09, 0xC0, 0x22, 0x1E, 0x01, 0x02, 0xB1,  // ..."....
                /* 0830 */  0x58, 0x0A, 0x19, 0x19, 0x95, 0x41, 0x04, 0x64,  // X....A.d
                /* 0838 */  0x95, 0xEF, 0x12, 0x01, 0x59, 0x33, 0x88, 0x80,  // ....Y3..
                /* 0840 */  0x9C, 0xDA, 0x02, 0x10, 0xD3, 0xF0, 0xC6, 0x10,  // ........
                /* 0848 */  0x90, 0x93, 0x79, 0x00, 0x62, 0x39, 0x41, 0x04,  // ..y.b9A.
                /* 0850 */  0x64, 0xA9, 0x26, 0x80, 0x98, 0x6E, 0x10, 0x01,  // d.&..n..
                /* 0858 */  0x59, 0xAB, 0x8A, 0x41, 0x50, 0x10, 0x01, 0x59,  // Y..AP..Y
                /* 0860 */  0xC7, 0xCB, 0x41, 0x40, 0x56, 0x05, 0x22, 0x20,  // ..A@V." 
                /* 0868 */  0xE7, 0xB3, 0x01, 0xC4, 0xC2, 0x82, 0x08, 0xC8,  // ........
                /* 0870 */  0x22, 0x75, 0x00, 0x31, 0xC5, 0x20, 0x02, 0xB2,  // "u.1. ..
                /* 0878 */  0x36, 0x1F, 0x40, 0x4C, 0x29, 0x88, 0x06, 0x44,  // 6.@L)..D
                /* 0880 */  0x1E, 0x05, 0x02, 0xB2, 0x04, 0x0A, 0x01, 0x39,  // .......9
                /* 0888 */  0x2E, 0x88, 0x80, 0x1C, 0x1E, 0x88, 0xE6, 0x78,  // .......x
                /* 0890 */  0x3F, 0x08, 0xC8, 0xA1, 0x40, 0x04, 0xE4, 0x00,  // ?...@...
                /* 0898 */  0xCF, 0x06, 0x01, 0x39, 0x0E, 0x88, 0x80, 0x2C,  // ...9...,
                /* 08A0 */  0x49, 0x0B, 0x10, 0xD3, 0x07, 0x22, 0x20, 0x87,  // I...." .
                /* 08A8 */  0x04, 0xA2, 0x89, 0x81, 0x68, 0x62, 0x2F, 0x40,  // ....hb/@
                /* 08B0 */  0x2C, 0x3F, 0x88, 0x80, 0xAC, 0xDF, 0x0C, 0x10,  // ,?......
                /* 08B8 */  0x4B, 0x03, 0x22, 0x20, 0x4B, 0x70, 0x03, 0xC4,  // K." Kp..
                /* 08C0 */  0xF4, 0x80, 0x08, 0xC8, 0xD9, 0x81, 0xA8, 0x92,  // ........
                /* 08C8 */  0x77, 0x81, 0x80, 0x89, 0x1D, 0x20, 0x16, 0x06,  // w.... ..
                /* 08D0 */  0x44, 0x40, 0x96, 0xF2, 0xEE, 0x12, 0x90, 0x75,  // D@.....u
                /* 08D8 */  0x81, 0x08, 0xC8, 0x1A, 0xFC, 0x00, 0x31, 0x45,  // ......1E
                /* 08E0 */  0x20, 0x1A, 0x1C, 0x79, 0x80, 0x68, 0x70, 0x04,  //  ..y.hp.
                /* 08E8 */  0x44, 0x40, 0x8E, 0x61, 0x08, 0x88, 0x82, 0x68,  // D@.a...h
                /* 08F0 */  0x00, 0xC4, 0xD1, 0x00, 0x28, 0x88, 0x80, 0x9C,  // ....(...
                /* 08F8 */  0x0B, 0x88, 0x86, 0x04, 0xA2, 0x81, 0x9E, 0x3F,  // .......?
                /* 0900 */  0xFA, 0xFF, 0x03, 0x39, 0x1E, 0x88, 0x80, 0x2C,  // ...9...,
                /* 0908 */  0x4A, 0x13, 0x10, 0x53, 0x08, 0x22, 0x20, 0x27,  // J..S." '
                /* 0910 */  0x04, 0xA2, 0x71, 0x81, 0x68, 0x34, 0x4F, 0x40,  // ..q.h4O@
                /* 0918 */  0x2C, 0x28, 0x88, 0x80, 0x2C, 0x48, 0x15, 0x08,  // ,(..,H..
                /* 0920 */  0x8B, 0x03, 0x42, 0x05, 0xB9, 0x02, 0x61, 0xFF,  // ..B...a.
                /* 0928 */  0x7F                                             // .
            })
    ...
    Scope (_SB.I2CD)
    {
        Device (TAS)
        {
            ...
            Name (_SUB, "10431EB3")  // _SUB: Subsystem ID
            Name (_UID, Zero)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
