 ...
 *
 * Disassembly of ./encoded/ssdt19.dat, Thu Jan 16 19:23:33 2025
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000083D (2109)
 *     Revision         0x01
 *     Checksum         0xAC
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "SSDT", 1, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    External (_SB_.PCI0.LPC0.EC0_.SEN1, FieldUnitObj)
    External (_SB_.PCI0.LPC0.EC0_.TCPU, FieldUnitObj)
    ...
    Scope (\_TZ)
    {
        ThermalZone (TZ01)
        {
            ...
            {
                Local0 = 0x0B74
                If (CondRefOf (\_SB.PCI0.LPC0.EC0.ECAV))
                {
                    If ((\_SB.PCI0.LPC0.EC0.ECAV == One))
                    {
                        If (CondRefOf (\_SB.PCI0.LPC0.EC0.Z009))
                        {
                            Acquire (\_SB.PCI0.LPC0.EC0.Z009, 0xFFFF)
                            If (CondRefOf (\_SB.PCI0.LPC0.EC0.SEN1))
                            {
                                Local0 = \_SB.PCI0.LPC0.EC0.SEN1 /* External reference */
