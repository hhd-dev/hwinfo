...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x97408D18, 0x0D)
    ...
    Scope (_SB.I2CB)
    {
        Device (SPKR)
        {
            ...
            Name (_SUB, "1F660105")  // _SUB: Subsystem ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
    ...
    Scope (_SB.I2CD)
    {
        Device (ACC)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.I2CD.ACC_._CRS.RBUF */
            }
            ...
            Method (ROTM, 0, NotSerialized)
            {
                ...
                Return (BUFC) /* \_SB_.I2CD.ACC_.ROTM.BUFC */
                Return (SBUF) /* \_SB_.I2CD.ACC_.ROTM.SBUF */
            }

            Method (CALB, 2, NotSerialized)
            {
                Name (A_X1, Zero)
                Name (A_Y2, Zero)
                Name (A_Z3, Zero)
                ...
                Name (A_Y, Zero)
                Name (A_Z, Zero)
                Name (SBUF, Buffer (0x03)
                {
                     0x00, 0x00, 0x00                                 // ...
                })
                If ((Arg0 == One))
                {
                    A_X1 = DerefOf (Arg1 [Zero])
                    A_Y2 = DerefOf (Arg1 [One])
                    A_Z3 = DerefOf (Arg1 [0x02])
                }

                If ((Arg0 == 0x02))
                {
                    SBUF [Zero] = A_X /* \_SB_.I2CD.ACC_.CALB.A_X_ */
                    SBUF [One] = A_Y /* \_SB_.I2CD.ACC_.CALB.A_Y_ */
                    SBUF [0x02] = A_Z /* \_SB_.I2CD.ACC_.CALB.A_Z_ */
                    Return (SBUF) /* \_SB_.I2CD.ACC_.CALB.SBUF */
                }
            }
