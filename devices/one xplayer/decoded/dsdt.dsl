 ...
 *
 * Disassembly of ./encoded/dsdt.dat, Mon Sep  9 22:23:42 2024
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00005CCB (23755)
 *     Revision         0x02
 *     Checksum         0x9C
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xCC781000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xCC785000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xCC9A6C98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCC9A6B18, 0x0D)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (GPP4)
            {
                ...
                OperationRegion (GI90, SystemMemory, 0xFED81500, 0x0400)
                Field (GI90, DWordAcc, NoLock, Preserve)
                {
                    Offset (0x168), 
                    WFIR,   32
                }
    ...
    Scope (_SB.I2CA)
    {
        Device (TCS0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.I2CA.TCS0._CRS.RBUF */
            }
