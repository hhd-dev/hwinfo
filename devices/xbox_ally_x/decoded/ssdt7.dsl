...
DefinitionBlock ("", "SSDT", 2, "AMD", "CPMPMF", 0x00000001)
{
    ...
    Scope (\_SB)
    {
        Name (PF0A, 0x7027D853)
        Name (PF9A, 0x7027D9C4)
        Name (PFBA, 0x7027D9CE)
        Name (PFCA, 0x7027D9D6)
        Name (PFTS, 0x7027D864)
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                {
                    QWordMemory (ResourceConsumer, PosDecode, MinNotFixed, MaxNotFixed, NonCacheable, ReadOnly,
                        ...
                        0x000000FD00BBD000, // Range Minimum
                        0x000000FD00C08000, // Range Maximum
