 ...
 *
 * Disassembly of ./encoded/ssdt2.dat, Wed Nov 22 23:04:53 2023
 *
        ...
        Device (TPM2)
        {
            ...
            Name (_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
            {
                Memory32Fixed (ReadWrite,
                    0x52ED2000,         // Address Base
                    0x00004000,         // Address Length
                    )
                Memory32Fixed (ReadWrite,
                    0x52ED6000,         // Address Base
                    0x00004000,         // Address Length
                    )
            })
            ...
            OperationRegion (TNVS, SystemMemory, 0x5AEB9000, 0x27)
            ...
            OperationRegion (CONA, SystemMemory, 0x5AEB9027, 0x30)
