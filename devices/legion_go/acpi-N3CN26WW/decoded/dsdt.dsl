 ...
 *
 * Disassembly of ./encoded/dsdt.dat, Wed Nov 22 23:04:53 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00013754 (79700)
 *     Revision         0x02
 *     Checksum         0x33
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
        ...
        Device (PCI0)
        {
                    ...
                    Device (LCD)
                    {
                        ...
                        Method (_DDC, 1, Serialized)  // _DDC: Display Data Current
                        {
                            Return (Buffer (0x0100)
                            {
                                ...
                                /* 0010 */  0x6C, 0x21, 0x01, 0x04, 0xA5, 0x1E, 0x12, 0x78,  // l!.....x
                                ...
                                /* 0078 */  0x6C, 0x61, 0x79, 0x0A, 0x20, 0x20, 0x01, 0xC6,  // lay.  ..
            ...
            Device (LPC0)
            {
                ...
                Device (EC0)
                {
                    ...
                    OperationRegion (EFAN, SystemMemory, 0xFE0B0800, 0x0100)
    ...
    Scope (_SB)
    {
        ...
        Device (GZFD)
        {
            ...
            Name (_WDG, Buffer (0x02A8)
            {
                ...
                /* 00B0 */  0x41, 0x38, 0x02, 0x01, 0xE6, 0x3C, 0xAF, 0xEC,  // A8...<..
