...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    OperationRegion (MDBG, SystemMemory, 0x5AEB2018, 0x00001004)
        ...
        Device (PCI0)
        {
            ...
            Device (LPC0)
            {
                ...
                Device (EC0)
                {
                    ...
                    OperationRegion (EC3A, EmbeddedControl, Zero, 0xFF)
                    Field (EC3A, ByteAcc, Lock, Preserve)
                    {
                        Offset (0x95), 
                        IBAC,   8
                    }
                ...
                If (!Acquire (VPCM, 0x012C))
                {
                    If ((^PCI0.LPC0.EC0.THPY == One))
                    {
                        ...
                        ElseIf ((ToInteger (Arg1) == 0x03))
                        {
                            If ((^PCI0.LPC0.EC0.ADPT == One))
                            {
                                ...
                                Else
                                {
                                    DPV2 = (^PCI0.LPC0.EC0.CSTP * 0x03E8)
                                }
                                ...
                                Else
                                {
                                    DPV3 = (^PCI0.LPC0.EC0.CFTP * 0x03E8)
                                }
                                ...
                                Else
                                {
                                    DV11 = (^PCI0.LPC0.EC0.CTDP * 0x03E8)
                                }
                            }
                            Else
                            {
                    ...
                    ElseIf ((ToInteger (Arg1) == 0x03))
                    {
                        If ((^PCI0.LPC0.EC0.ADPT == One))
                        {
                            ...
                            Else
                            {
                                DPV1 = (^PCI0.LPC0.EC0.CTDP * 0x03E8)
                            }
        ...
        Device (GZFD)
        {
            ...
            Method (GLT1, 1, Serialized)
            {
                Switch (ToInteger (Arg0))
                {
                    ...
                    Case (0x24)
                    {
                        If ((^^PCI0.LPC0.EC0.LEDM == Zero))
                        {
                            C008 = 0x03
                        }

                        If ((^^PCI0.LPC0.EC0.LEDM == One))
                        {
                            C008 = One
                        }
            ...
            Method (SLT2, 1, Serialized)
            {
                ...
                Switch (ToInteger (C009))
                {
                    ...
                    Case (0x24)
                    {
                        If ((C00B == One))
                        {
                            ^^PCI0.LPC0.EC0.LEDM = One
                        }

                        If ((C00B == 0x02)){}
                        If ((C00B == 0x03))
                        {
                            ^^PCI0.LPC0.EC0.LEDM = Zero
                        }
                    }
