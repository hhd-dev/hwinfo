 ...
 *
 * Disassembly of ./encoded/dsdt.dat, Fri Dec 15 00:33:33 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008ADA (35546)
 *     Revision         0x02
 *     Checksum         0x10
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x925C0000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x925C4000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0x976C2F18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x976AFD18, 0x0D)
