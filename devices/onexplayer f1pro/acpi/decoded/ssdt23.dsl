...
DefinitionBlock ("", "SSDT", 2, "AMD", "WwanSsdt", 0x00000001)
{
    ...
    Scope (\_SB.PCI0.GPP7)
    {
        ...
        PowerResource (P0WW, 0x00, 0x0000)
        {
            ...
            {
                M460 ("OEM-ASL-\\_SB.PCI0.GPP7.P0WW._RST\n", Zero, Zero, Zero, Zero, Zero, Zero)
                M000 (0x3322)
            ...
            {
                M460 ("OEM-ASL-\\_SB.PCI0.GPP7.P0WW._STA\n", Zero, Zero, Zero, Zero, Zero, Zero)
                M000 (0x33AA)
            ...
            Method (_ON, 0, NotSerialized)  // _ON_: Power On
            {
                ...
                If ((D0WW != One))
                {
                    M460 ("OEM-ASL-\\_SB.PCI0.GPP7.P0WW._ON\n", Zero, Zero, Zero, Zero, Zero, Zero)
                    WWON ()
                    M429 (Zero, 0x02, 0x05, 0x54, Zero, 0x02, Zero)
                    Local0 = M017 (Zero, 0x02, 0x05, 0x19, Zero, 0x08)
                    Sleep (0x0A)
                    Local1 = M017 (Local0, Zero, Zero, Zero, Zero, 0x20)
                    If (((Local1 == 0x10041EAC) || (Local1 == 0x030817CB)))
                    {
            ...
            Method (_OFF, 0, NotSerialized)  // _OFF: Power Off
            {
                ...
                If ((D0WW != Zero))
                {
                    M460 ("OEM-ASL-\\_SB.PCI0.GPP7.P0WW._OFF\n", Zero, Zero, Zero, Zero, Zero, Zero)
                    WOFF ()
                    D0WW = Zero
                }
        ...
        Method (WWON, 0, NotSerialized)
        {
            If (\_SB.PCI0.SBRG.ECOK ())
            {
                ...
                If (((Local0 & 0x10) != 0x10))
                {
                    ...
                    {
                        Local1 = M017 (Zero, 0x02, 0x05, 0x6B, Zero, 0x08)
                        Local2 = (Local2 - One)
                        Stall (0x63)
                    }
        ...
        Method (WOFF, 0, NotSerialized)
        {
            If (\_SB.PCI0.SBRG.ECOK ())
            {
                ...
                {
                    M402 (Zero, 0x02, 0x05)
                    Local2 = M017 (Zero, 0x02, 0x05, 0x70, Zero, 0x10)
                    M018 (Zero, 0x02, 0x05, 0x70, Zero, 0x10, (Local2 & 0xEFFF))
                    \_SB.ALIB (0x12, 0x15)
                    M018 (Zero, 0x02, 0x05, 0x70, Zero, 0x10, Local2)
                    Sleep (0x0A)
                    Local0 = \_SB.PCI0.SBRG.EC0.GPO3 /* External reference */
                    Local1 = (Local0 & 0xEF)
                    \_SB.PCI0.SBRG.EC0.GPO3 = Local1
    ...
    Scope (\_SB.PCI0.GPP7.WWAN)
    {
        ...
        {
            M460 ("OEM-ASL-\\_SB.PCI0.GPP7._DSW\n", Zero, Zero, Zero, Zero, Zero, Zero)
            M000 (0x335D)
            Local0 = (Arg0 + 0x2D00)
        }
        ...
        Method (_RST, 0, NotSerialized)  // _RST: Device Reset
        {
            M460 ("OEM-ASL-\\_SB.PCI0.GPP7._RST\n", Zero, Zero, Zero, Zero, Zero, Zero)
            M000 (0x3312)
            Acquire (\_SB.PCI0.SBRG.EC0.Z009, 0xFFFF)
            Local0 = \_SB.PCI0.SBRG.EC0.GPO9 /* External reference */
            Local1 = (Local0 & 0xDF)
            ...
            {
                M460 ("OEM-ASL-\\_SB.PCI0.GPP7.WWAN-FM350\n", Zero, Zero, Zero, Zero, Zero, Zero)
                Sleep (0x0F)
            }
            Else
            {
                M460 ("PLA-ASL-\\_SB.PCI0.GPP7.WWAN-NonFM350\n", Zero, Zero, Zero, Zero, Zero, Zero)
                Sleep (0xC8)
            }
        ...
        {
            M460 ("OEM-ASL-\\_SB.PCI0.GPP7._DSM\n", Zero, Zero, Zero, Zero, Zero, Zero)
