...
DefinitionBlock ("", "SSDT", 2, "AMD", "UPEP", 0x00000001)
{
    ...
    External (_SB_.PCI0.GPP5, UnknownObj)
    External (_SB_.PCI0.GPP5.WLAN, UnknownObj)
                ...
                ElseIf ((Arg0 == ToUUID ("11e00d56-ce64-47ce-837b-1f898f9aa461") /* Unknown UUID */))
                {
                    ...
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (0x08)
                        {
                            ...
                            If (CondRefOf (\_SB.PCI0.GPP5.WLAN))
                            {
                                M460 ("    Notify (\\_SB.PCI0.GPP5.WLAN, 0x1)\n", Zero, Zero, Zero, Zero, Zero, Zero)
                                Notify (\_SB.PCI0.GPP5, One) // Device Check
                                Notify (\_SB.PCI0.GPP5.WLAN, One) // Device Check
                            }
