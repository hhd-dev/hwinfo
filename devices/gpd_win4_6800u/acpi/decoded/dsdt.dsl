 ...
 *
 * Disassembly of ./encoded/dsdt.dat, Tue Jan  9 17:11:45 2024
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00006B51 (27473)
 *     Revision         0x02
 *     Checksum         0x9D
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB3182000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB3186000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xB8274F18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB8262D18, 0x0E)
        ...
        Device (RHUB)
        {
            ...
            Device (PRT3)
            {
                ...
                Name (PLD1, Package (0x01)
                {
                    ...
                    {
                        /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                        /* 0008 */  0x00, 0x00, 0x80, 0x03, 0x03, 0x00, 0x00, 0x00,  // ........
                        /* 0010 */  0x00, 0x00, 0x00, 0x00                           // ....
                    }
                })
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
        ...
        Device (RHUB)
        {
            ...
            Device (PRT1)
            {
                ...
                Name (PLD1, Package (0x01)
                {
                    ...
                    {
                        /* 0000 */  0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                        /* 0008 */  0x01, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,  // ........
                        /* 0010 */  0x00, 0x00, 0x00, 0x00                           // ....
                    }
                })
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
    ...
    Scope (_SB.I2CC)
    {
        Device (BMA2)
        {
            ...
            OperationRegion (CMS2, SystemIO, 0x70, 0x02)
    ...
    Scope (_SB.I2CD)
    {
        Device (TPDD)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (WBUF) /* \_SB_.I2CD.TPDD._CRS.WBUF */
            }
