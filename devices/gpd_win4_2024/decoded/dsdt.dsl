...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB7A07000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB7A0B000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0xB828DF18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB827AD18, 0x0D)
    ...
    OperationRegion (SSDB, SystemMemory, 0xB827AD98, 0x0040)
    ...
    OperationRegion (ONVS, SystemMemory, 0xB828D698, 0x0400)
