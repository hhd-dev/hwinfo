 ...
 *
 * Disassembly of ./encoded/dsdt.dat, Fri Oct 25 15:47:11 2024
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000086B1 (34481)
 *     Revision         0x02
 *     Checksum         0xA7
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB79FE000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB7A02000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0xB8285F18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB8272D18, 0x0D)
    ...
    OperationRegion (SSDB, SystemMemory, 0xB8272D98, 0x0040)
    ...
    OperationRegion (ONVS, SystemMemory, 0xB8285698, 0x0400)
    ...
    Scope (_SB.I2CB)
    {
        Device (TPNL)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (WBUF) /* \_SB_.I2CB.TPNL._CRS.WBUF */
            }
