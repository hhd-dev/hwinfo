...
DefinitionBlock ("", "SSDT", 2, "AMD", "NVME", 0x00000001)
{
    ...
    Scope (\_SB.PCI0.GPP3)
    {
        ...
        {
            M460 ("PLA-ASL-_SB.PCI0.GPP3.GPPM\n", Zero, Zero, Zero, Zero, Zero, Zero)
            Local0 = Zero
        ...
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GPP3._PRW Return Package (0x8, 0x4)\n", Zero, Zero, Zero, Zero, Zero, Zero)
            Return (Package (0x02)
            {
                0x08, 
                0x04
        ...
        {
            M460 ("PLA-ASL-_SB.PCI0.GPP3._INI\n", Zero, Zero, Zero, Zero, Zero, Zero)
            If ((M4C0 != Zero))
            {
        ...
        Method (PWEN, 0, NotSerialized)
        {
            ...
            {
                WD3C = One
                Local2 = CLKR /* \_SB_.PCI0.GPP3.PWEN.CLKR */
                CLKR &= CMSK /* \_SB_.PCI0.GPP3.CMSK */
                M010 (PPWR, One)
                CLKR = Local2
                If ((TPPL != Zero))
                {
        ...
        {
            M460 ("PLA-ASL-_SB.PCI0.GPP3.PWDI\n", Zero, Zero, Zero, Zero, Zero, Zero)
        }
