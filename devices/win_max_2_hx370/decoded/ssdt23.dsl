...
DefinitionBlock ("", "SSDT", 2, "AMD", "NVME", 0x00000001)
{
    ...
    External (_SB_.PCI0.GP10._ADR, IntObj)
    ...
    Scope (\_SB.PCI0.GP10)
    {
        ...
        {
            M460 ("PLA-ASL-_SB.PCI0.GP10.GPPM\n", Zero, Zero, Zero, Zero, Zero, Zero)
            Local0 = Zero
        ...
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GP10._PRW Return Package (0x8, 0x4)\n", Zero, Zero, Zero, Zero, Zero, Zero)
            Return (Package (0x02)
            {
                0x08, 
                0x04
        ...
        {
            M460 ("PLA-ASL-_SB.PCI0.GP10._INI\n", Zero, Zero, Zero, Zero, Zero, Zero)
            If ((M4C0 != Zero))
            {
        ...
        {
            M460 ("PLA-ASL-_SB.PCI0.GP10.PWEN\n", Zero, Zero, Zero, Zero, Zero, Zero)
            ...
            {
                WD3C = One
                Local2 = CLKR /* \_SB_.PCI0.GP10.PWEN.CLKR */
                CLKR &= CMSK /* \_SB_.PCI0.GP10.CMSK */
                M010 (PPWR, One)
                CLKR = Local2
                If ((TPPL != Zero))
                {
        ...
        {
            M460 ("PLA-ASL-_SB.PCI0.GP10.PWDI\n", Zero, Zero, Zero, Zero, Zero, Zero)
        }
        ...
        PowerResource (P0NV, 0x00, 0x0000)
        {
            ...
            {
                M000 (0x30AA)
                M460 ("PLA-ASL-\\_SB.PCI0.GP10.P0NV._STA\n", Zero, Zero, Zero, Zero, Zero, Zero)
                Return (D0NV) /* \_SB_.PCI0.GP10.P0NV.D0NV */
            }

            Method (_ON, 0, NotSerialized)  // _ON_: Power On
            {
                M000 (0x30D0)
                M460 ("PLA-ASL-\\_SB.PCI0.GP10.P0NV._ON\n", Zero, Zero, Zero, Zero, Zero, Zero)
                If ((M4C0 != Zero))
                {
                    If ((M049 (M4C0, 0x10) == One))
                    {
            ...
            {
                M000 (0x30D3)
                M460 ("PLA-ASL-\\_SB.PCI0.GP10.P0NV._OFF\n", Zero, Zero, Zero, Zero, Zero, Zero)
                D0NV = Zero
                M000 (0x30D5)
            }
        }
        ...
        {
            M000 (0x3051)
            M460 ("PLA-ASL-\\_SB.PCI0.GP10._PS0\n", Zero, Zero, Zero, Zero, Zero, Zero)
            If ((M4C0 != Zero))
            {
                If ((M049 (M4C0, 0x10) == One))
                {
        ...
        {
            M000 (0x3054)
            M460 ("PLA-ASL-\\_SB.PCI0.GP10._PS3\n", Zero, Zero, Zero, Zero, Zero, Zero)
            If ((M4C0 != Zero))
            {
                If ((M049 (M4C0, 0x10) == One))
                {
        ...
        Device (NVME)
        {
            ...
            Name (_S0W, 0x04)  // _S0W: S0 Device Wake State
            Name (EPR0, Package (0x01)
            {
                P0NV
            })
            Name (EPR3, Package (0x01)
            {
                P0NV
            })
            Method (_PS0, 0, NotSerialized)  // _PS0: Power State 0
            {
                M000 (0x3050)
                M460 ("PLA-ASL-\\_SB.PCI0.GP10.NVME._PS0\n", Zero, Zero, Zero, Zero, Zero, Zero)
            }

            Method (_PS3, 0, NotSerialized)  // _PS3: Power State 3
            {
                M000 (0x3053)
                M460 ("PLA-ASL-\\_SB.PCI0.GP10.NVME._PS3\n", Zero, Zero, Zero, Zero, Zero, Zero)
            }
