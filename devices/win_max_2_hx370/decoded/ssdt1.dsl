...
DefinitionBlock ("", "SSDT", 2, "AMD", "AmdTable", 0x00000002)
{
    Scope (\_SB)
    {
        ...
        Name (ADAT, Buffer (0x0520)
        {
            ...
            /* 0060 */  0x00, 0x00, 0x00, 0x16, 0x16, 0xFF, 0xFF, 0x03,  // ........
            /* 0068 */  0x00, 0x02, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
            /* 0070 */  0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x17,  // ........
            /* 0078 */  0x17, 0xFF, 0xFF, 0x04, 0x00, 0x02, 0x03, 0x00,  // ........
            /* 0080 */  0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01,  // ........
            /* 0088 */  0x00, 0x00, 0x01, 0x03, 0x00, 0xFF, 0xFF, 0x00,  // ........
            /* 0090 */  0x00, 0x03, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
        ...
        Method (ALIB, 2, NotSerialized)
        {
            ...
            If ((Arg0 == 0xAA))
            {
                A007 (0xAA98)
                Local6 = Buffer (0x18){}
                CreateDWordField (Local6, 0x00, A071)
        ...
        Method (A029, 2, NotSerialized)
        {
            ...
            While ((Local0 < 0x0B))
            {
                Local1 = A129 (Local0, Arg1)
                If ((Local1 == 0x01))
                {
                    Local2 = A130 (Local0, Arg0)
                    Break
                }
            ...
            CreateByteField (Local7, 0x02, A079)
            CreateByteField (Local7, 0x03, A131)
            A023 = 0x04
            A079 = 0x00
            If ((Local2 == 0x00))
            {
        ...
        Method (A129, 2, NotSerialized)
        {
            If ((Arg0 == 0x00))
            {
                Return (\_SB.AWR0.ABR0.A124 (Arg1))
            }

            If ((Arg0 == 0x01))
            {
                Return (\_SB.AWR0.ABR1.A124 (Arg1))
            }

            If ((Arg0 == 0x02))
            {
                Return (\_SB.AWR0.ABR2.A124 (Arg1))
            }

            If ((Arg0 == 0x03))
            {
                Return (\_SB.AWR0.ABR3.A124 (Arg1))
            }

            If ((Arg0 == 0x04))
            {
                Return (\_SB.AWR0.ABR4.A124 (Arg1))
            }

            If ((Arg0 == 0x05))
            {
                Return (\_SB.AWR0.ABR5.A124 (Arg1))
            }

            If ((Arg0 == 0x06))
            {
                Return (\_SB.AWR0.ABR6.A124 (Arg1))
            }
        }
        ...
        OperationRegion (A160, SystemMemory, AGRB, 0x1000)
        Field (A160, DWordAcc, Lock, Preserve)
        {
            Offset (0xB8), 
            A161,   32
        }

        BankField (A160, A161, 0x03B10928, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A159,   32
        }

        BankField (A160, A161, 0x03B10978, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A152,   32
        }

        BankField (A160, A161, 0x03B10998, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A153,   32
        }

        BankField (A160, A161, 0x03B1099C, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A154,   32
        }

        BankField (A160, A161, 0x03B109A0, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A155,   32
        }

        BankField (A160, A161, 0x03B109A4, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A156,   32
        }

        BankField (A160, A161, 0x03B109A8, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A157,   32
        }

        BankField (A160, A161, 0x03B109AC, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A158,   32
        }

        BankField (A160, A161, 0x13B00084, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A134,   32
        }

        BankField (A160, A161, 0x11140280, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A135,   32
        }

        BankField (A160, A161, 0x11141280, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A136,   32
        }

        BankField (A160, A161, 0x11142280, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A137,   32
        }

        BankField (A160, A161, 0x11143280, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A138,   32
        }

        BankField (A160, A161, 0x11144280, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A139,   32
        }

        BankField (A160, A161, 0x11240280, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A140,   32
        }

        BankField (A160, A161, 0x11241280, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A141,   32
        }

        BankField (A160, A161, 0x11242280, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A142,   32
        }

        BankField (A160, A161, 0x11243280, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A143,   32
        }

        BankField (A160, A161, 0x11244280, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A144,   32
        }

        BankField (A160, A161, 0x11245280, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A145,   32
        }

        BankField (A160, A161, 0x11140294, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A181,   32
        }

        BankField (A160, A161, 0x11141294, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A182,   32
        }

        BankField (A160, A161, 0x11142294, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A183,   32
        }

        BankField (A160, A161, 0x11143294, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A184,   32
        }

        BankField (A160, A161, 0x0C9109C8, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A170,   32
        }

        BankField (A160, A161, 0x0C9109CC, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A171,   32
        }

        BankField (A160, A161, 0x0C9109D0, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A172,   32
        }

        BankField (A160, A161, 0x0C9109D4, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A173,   32
        }

        BankField (A160, A161, 0x0C9109D8, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A174,   32
        }

        BankField (A160, A161, 0x0C9109DC, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A175,   32
        }

        BankField (A160, A161, 0x0C9109E0, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A176,   32
        }

        BankField (A160, A161, 0x0C910954, DWordAcc, Lock, Preserve)
        {
            Offset (0xBC), 
            A177,   32
        }

        Method (A132, 2, NotSerialized)
        {
            If ((Arg0 == 0x00))
            {
            ...
            If ((Arg0 == 0x07))
            {
                Return (\_SB.AWR0.ABR7.A112 (Arg1))
            }

            If ((Arg0 == 0x08))
            {
                Return (\_SB.AWR0.ABR8.A112 (Arg1))
            }

            If ((Arg0 == 0x09))
            {
                Return (\_SB.AWR0.ABR9.A112 (Arg1))
            }

            If ((Arg0 == 0x0A))
            {
                Return (\_SB.AWR0.ABRA.A112 (Arg1))
            }
        }
        ...
        Method (A045, 1, NotSerialized)
        {
            ...
            If ((0xFF == Local0))
            {
                Local0 = \_SB.AWR0.ABR0.A116 (Arg0)
            }

            If ((0xFF == Local0))
            {
                Local0 = \_SB.AWR0.ABR1.A116 (Arg0)
            }

            If ((0xFF == Local0))
            {
                Local0 = \_SB.AWR0.ABR2.A116 (Arg0)
            }

            If ((0xFF == Local0))
            {
                Local0 = \_SB.AWR0.ABR3.A116 (Arg0)
            }

            If ((0xFF == Local0))
            {
                Local0 = \_SB.AWR0.ABR4.A116 (Arg0)
            }

            If ((0xFF == Local0))
            {
                Local0 = \_SB.AWR0.ABR5.A116 (Arg0)
            }

            If ((0xFF == Local0))
            {
                Local0 = \_SB.AWR0.ABR6.A116 (Arg0)
            }

            If ((0xFF == Local0))
            {
                Local0 = \_SB.AWR0.ABR7.A116 (Arg0)
            }

            If ((0xFF == Local0))
            {
                Local0 = \_SB.AWR0.ABR8.A116 (Arg0)
            }

            If ((0xFF == Local0))
            {
                Local0 = \_SB.AWR0.ABR9.A116 (Arg0)
            }

            If ((0xFF == Local0))
            {
                Local0 = \_SB.AWR0.ABRA.A116 (Arg0)
            }
        ...
        {
            Acquire (\_SB.AM00, 0xFFFF)
            CreateDWordField (Arg1, 0x00, A146)
            CreateDWordField (Arg1, 0x04, A147)
            CreateDWordField (Arg1, 0x08, A148)
            CreateDWordField (Arg1, 0x0C, A149)
            CreateDWordField (Arg1, 0x10, A150)
            CreateDWordField (Arg1, 0x14, A151)
            A152 = 0x00
            While ((A152 != 0x00))
            {
                A152 = 0x00
        ...
        {
            Acquire (\_SB.AM00, 0xFFFF)
            BankField (A160, A161, Arg0, DWordAcc, NoLock, Preserve)
            {
                Offset (0xBC), 
                A162,   32
            }
        ...
        {
            Acquire (\_SB.AM00, 0xFFFF)
            CreateDWordField (Arg1, 0x00, A164)
            CreateDWordField (Arg1, 0x04, A165)
            CreateDWordField (Arg1, 0x08, A166)
            CreateDWordField (Arg1, 0x0C, A167)
            CreateDWordField (Arg1, 0x10, A168)
            CreateDWordField (Arg1, 0x14, A169)
            Local0 = (0x80000000 & A170) /* \_SB_.A170 */
            While ((Local0 == 0x00))
            {
                Local0 = (0x80000000 & A170) /* \_SB_.A170 */
            }

            A171 = A164 /* \_SB_.A046.A164 */
            A172 = A165 /* \_SB_.A046.A165 */
            A173 = A166 /* \_SB_.A046.A166 */
            A174 = A167 /* \_SB_.A046.A167 */
            A175 = A168 /* \_SB_.A046.A168 */
            A176 = A169 /* \_SB_.A046.A169 */
            Local1 = (Arg0 & 0xFF)
            Local1 <<= 0x08
            A170 = Local1
            A177 = 0xFFFFFFFF
        ...
        {
            CreateWordField (Arg0, 0x00, A178)
            Local7 = Buffer (0x18){}
            CreateDWordField (Local7, 0x00, A012)
            CreateDWordField (Local7, 0x04, A013)
            CreateDWordField (Local7, 0x08, A014)
            ...
            While ((Local0 < A178))
            {
                ...
                If ((Local1 == 0x30))
                {
                    ...
                    Acquire (\_SB.AM00, 0xFFFF)
                    Local3 = Buffer (0x08){}
                    CreateDWordField (Local3, 0x00, A179)
                    CreateDWordField (Local3, 0x04, A180)
                    A179 = A153 /* \_SB_.A153 */
                    A180 = A154 /* \_SB_.A154 */
                    Release (\_SB.AM00)
                    Return (Local3)
        ...
        Device (AWR0)
        {
            ...
            Device (ABR0)
            {
                ...
                Name (AB0C, 0x00)
                Name (AB0D, 0x00)
                OperationRegion (A117, SystemMemory, (AGRB + ((DerefOf (\_SB.ADAT [(AB12 + 0x0D)]
                ...
                {
                    Local0 = 0x00
                    Local1 = A114 (Local0, 0x00)
                    Local2 = A114 (Local0, 0x08)
                            ...
                            If (((Local1 == 0x1002) || (Local1 == 0x1022)))
                            {
                                ...
                                While ((Local0 < 0x30))
                                {
                                    ...
                                    If ((((Local4 & 0x09) == 0x00) && (Local4 != 0x00)))
                                    {
                                        ...
                                        {
                                            Local0 += 0x04
                                            Local5 = A114 (0x00, Local0)
                                        }

                                        If ((Arg0 != 0x00))
                                        {
                                            A115 (0x25, (Local4 & 0xFFFFFFF0), 0x00)
                                            A115 (0x26, Local5, 0x00)
                                            A115 (0x28, 0x00, 0x00)
                                            A115 (0x27, 0x00, 0x00)
                                            Break
                                        }
                ...
                Method (A128, 2, NotSerialized)
                {
                    If ((A114 (Arg0, 0x00) == 0xFFFFFFFF))
                    {
                        Return (0x00)
                    }

                    Local0 = A114 (Arg0, 0x34)
                    While (0x01)
                    {
                        Local1 = A114 (Arg0, (Local0 & 0xFF))
                        If (((Local1 & 0xFF) == Arg1))
                        {
                            Return ((Local0 & 0xFF))
                        }
                ...
                {
                    Local0 = 0x00
                    If ((A114 (Local0, 0x00) != 0xFFFFFFFF))
                    {
                        Local1 = (A114 (Local0, 0x08) & 0x80)
                        If ((Local1 == 0x80))
                        {
                            Local7 = 0x07
                        }
                        ...
                        While ((Local0 <= Local7))
                        {
                            ...
                            If ((Arg0 == 0x00))
                            {
                                Local2 = A114 (Local0, (Local1 + 0x10))
                                A126 (Local0, (Local1 + 0x10), (Local2 & ~0x03))
                                AESP [Local0] = Local2
                            }
                            Else
                            {
                                Local2 = DerefOf (AESP [Local0])
                                A126 (Local0, (Local1 + 0x10), Local2)
                            }
                ...
                Method (A126, 3, Serialized)
                {
                    Local0 = (AGRB + (A111 << 0x14))
                    Local0 += (Arg0 << 0x0C)
                    Local0 += Arg1
                ...
                Method (A114, 2, Serialized)
                {
                    ...
                    Return (ADRR) /* \_SB_.AWR0.ABR0.A114.ADRR */
                }

                Method (A124, 1, NotSerialized)
                {
                    If ((AB0B != 0x01))
                    {
                        Return (0x00)
                ...
                Method (A125, 1, NotSerialized)
                {
                    ...
                    {
                        A108 (0x00)
                        Local0 = A114 (0x00, 0x04)
                        If ((Local0 != 0xFFFFFFFF))
                        {
                            A126 (0x00, 0x04, (Local0 & ~0x04))
                            Local0 = A114 (0x01, 0x04)
                            If ((Local0 != 0xFFFFFFFF))
                            {
                                A126 (0x01, 0x04, (Local0 & ~0x04))
                            }
                        }
                    ...
                    While ((Local0 != 0x08))
                    {
                        If ((Local0 == 0x01))
                        {
                            A127 (0x29, Local1, 0x00, 0x00, 0x00)
                            Local2 = 0x01
                            Local0 = 0x08
                        }
                        ...
                        {
                            A114 (0x00, 0x00)
                            A127 (0x2A, Local1, 0x00, 0x00, 0x00)
                            AB05 = 0x00
                            AB04 = 0x00
                            AB10 = 0x00
                            Local2 = 0x00
                    ...
                    A118 = A109 /* \_SB_.AWR0.ABR0.A125.A109 */
                    If ((A109 != 0x00))
                    {
                        A108 (0x01)
                    }
            ...
            Device (ABR1)
            {
                ...
                Method (A114, 2, Serialized)
                {
                    ...
                    Return (ADRR) /* \_SB_.AWR0.ABR1.A114.ADRR */
                }
                ...
                Method (A125, 1, NotSerialized)
                {
                    ...
                    A118 = A109 /* \_SB_.AWR0.ABR1.A125.A109 */
                    If ((A109 != 0x00))
                    {
                        A108 (0x01)
                    }
            ...
            Device (ABR2)
            {
                ...
                Method (A114, 2, Serialized)
                {
                    ...
                    Return (ADRR) /* \_SB_.AWR0.ABR2.A114.ADRR */
                }
                ...
                Method (A125, 1, NotSerialized)
                {
                    ...
                    A118 = A109 /* \_SB_.AWR0.ABR2.A125.A109 */
                    If ((A109 != 0x00))
                    {
                        A108 (0x01)
                    }
            ...
            Device (ABR3)
            {
                ...
                Method (A114, 2, Serialized)
                {
                    ...
                    Return (ADRR) /* \_SB_.AWR0.ABR3.A114.ADRR */
                }
                ...
                Method (A125, 1, NotSerialized)
                {
                    ...
                    A118 = A109 /* \_SB_.AWR0.ABR3.A125.A109 */
                    If ((A109 != 0x00))
                    {
                        A108 (0x01)
                    }
            ...
            Device (ABR4)
            {
                ...
                Method (A114, 2, Serialized)
                {
                    ...
                    Return (ADRR) /* \_SB_.AWR0.ABR4.A114.ADRR */
                }
                ...
                Method (A125, 1, NotSerialized)
                {
                    ...
                    A118 = A109 /* \_SB_.AWR0.ABR4.A125.A109 */
                    If ((A109 != 0x00))
                    {
                        A108 (0x01)
                    }
            ...
            Device (ABR5)
            {
                ...
                Method (A114, 2, Serialized)
                {
                    ...
                    Return (ADRR) /* \_SB_.AWR0.ABR5.A114.ADRR */
                }
                ...
                Method (A125, 1, NotSerialized)
                {
                    ...
                    A118 = A109 /* \_SB_.AWR0.ABR5.A125.A109 */
                    If ((A109 != 0x00))
                    {
                        A108 (0x01)
                    }
            ...
            Device (ABR6)
            {
                ...
                Method (A114, 2, Serialized)
                {
                    ...
                    Return (ADRR) /* \_SB_.AWR0.ABR6.A114.ADRR */
                }
                ...
                Method (A125, 1, NotSerialized)
                {
                    ...
                    A118 = A109 /* \_SB_.AWR0.ABR6.A125.A109 */
                    If ((A109 != 0x00))
                    {
                        A108 (0x01)
                    }
            ...
            Device (ABR7)
            {
                ...
                Method (A114, 2, Serialized)
                {
                    ...
                    Return (ADRR) /* \_SB_.AWR0.ABR7.A114.ADRR */
                }
                ...
                Method (A125, 1, NotSerialized)
                {
                    ...
                    A118 = A109 /* \_SB_.AWR0.ABR7.A125.A109 */
                    If ((A109 != 0x00))
                    {
                        A108 (0x01)
                    }
            ...
            Device (ABR8)
            {
                ...
                Method (A114, 2, Serialized)
                {
                    ...
                    Return (ADRR) /* \_SB_.AWR0.ABR8.A114.ADRR */
                }
                ...
                Method (A125, 1, NotSerialized)
                {
                    ...
                    A118 = A109 /* \_SB_.AWR0.ABR8.A125.A109 */
                    If ((A109 != 0x00))
                    {
                        A108 (0x01)
                    }
            ...
            Device (ABR9)
            {
                ...
                Method (A114, 2, Serialized)
                {
                    ...
                    Return (ADRR) /* \_SB_.AWR0.ABR9.A114.ADRR */
                }
                ...
                Method (A125, 1, NotSerialized)
                {
                    ...
                    A118 = A109 /* \_SB_.AWR0.ABR9.A125.A109 */
                    If ((A109 != 0x00))
                    {
                        A108 (0x01)
                    }
            ...
            Device (ABRA)
            {
                ...
                Method (A114, 2, Serialized)
                {
                    ...
                    Return (ADRR) /* \_SB_.AWR0.ABRA.A114.ADRR */
                }
                ...
                Method (A125, 1, NotSerialized)
                {
                    ...
                    A118 = A109 /* \_SB_.AWR0.ABRA.A125.A109 */
                    If ((A109 != 0x00))
                    {
                        A108 (0x01)
                    }
        ...
        Method (A186, 2, NotSerialized)
        {
            ...
            If ((Arg0 == 0x07))
            {
                Return (\_SB.AWR0.ABR7.A113 (Arg1))
            }

            If ((Arg0 == 0x08))
            {
                Return (\_SB.AWR0.ABR8.A113 (Arg1))
            }

            If ((Arg0 == 0x09))
            {
                Return (\_SB.AWR0.ABR9.A113 (Arg1))
            }

            If ((Arg0 == 0x0A))
            {
                Return (\_SB.AWR0.ABRA.A113 (Arg1))
            }
        }
