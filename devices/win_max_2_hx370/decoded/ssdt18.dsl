    ...
    Scope (\_SB.GPIO)
    {
        ...
        Method (_EVT, 1, Serialized)  // _EVT: Event
        {
            ...
            Switch (ToInteger (Arg0))
            {
                ...
                {
                    M000 (0x3909)
                    M460 ("    Notify (\\_SB.PCI0.GPP4.SDCR, 0x01)\n", Zero, Zero, Zero, Zero, Zero, Zero)
                }
                Case (0x0B)
                {
                    M000 (0x390B)
                ...
                Case (0x12)
                {
                    ...
                    If ((\WLD3 == One))
                    {
                        ...
                        M460 ("    Notify (\\_SB.PCI0.GPP5.WLAN, 0x02)\n", Zero, Zero, Zero, Zero, Zero, Zero)
                        Notify (\_SB.PCI0.GPP5.WLAN, 0x02) // Device Wake
                        Sleep (0x0A)
                ...
                Case (0x36)
                {
                    ...
                    If ((\HPDW == One))
                    {
                        M460 ("    Notify (\\_SB.PCI0.GPPA.MP2C(HPDW):PWRB 0x80)\n", Zero, Zero, Zero, Zero, Zero, Zero)
                        If ((\_SB.CMBS == Zero))
                        {
                            Notify (\_SB.PWRB, 0x80) // Status Change
                        }
