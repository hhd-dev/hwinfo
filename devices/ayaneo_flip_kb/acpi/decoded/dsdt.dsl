...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    External (_SB_.PCI0.GPP0.SWUS.SWDS.VGA_, UnknownObj)
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x9690A000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x9690E000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0x97416F18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x97403D18, 0x0D)
    ...
    Scope (_SB.I2CB)
    {
        Device (AWDZ)
        {
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("1cc539cd-5a26-4288-a572-25c5744ebf1b") /* Unknown UUID */))
                {
                    If ((Arg2 == Zero))
                    {
                        Return (Buffer (0x04)
    ...
    Scope (_SB.I2CA)
    {
        ...
        {
            Name (_ADR, One)  // _ADR: Address
            Name (_HID, "GDIX1003")  // _HID: Hardware ID
            Name (_CID, "GDIX1003")  // _CID: Compatible ID
            Name (_S0W, Zero)  // _S0W: S0 Device Wake State
            Name (_DEP, Package (0x02)  // _DEP: Dependencies
            {
                GPIO, 
