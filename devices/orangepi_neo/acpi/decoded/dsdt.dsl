...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x96B74000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x96B78000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0x973F9D18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x973F9D98, 0x0D)
    ...
    Scope (_SB.I2CA)
    {
        ...
        {
            Name (_ADR, One)  // _ADR: Address
            Name (_HID, "OPI0001")  // _HID: Hardware ID
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Return (SBFB) /* \_SB_.I2CA.TPD0.SBFB */
            }
    ...
    Scope (_SB.I2CC)
    {
        ...
        {
            Name (_ADR, One)  // _ADR: Address
            Name (_HID, "OPI0002")  // _HID: Hardware ID
            Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
            Name (_UID, One)  // _UID: Unique ID
            Name (_S0W, 0x04)  // _S0W: S0 Device Wake State
            Name (SBFB, ResourceTemplate ()
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Return (SBFB) /* \_SB_.I2CC.TPD0.SBFB */
            }
    ...
    Scope (_SB.I2CB)
    {
        Device (GDTP)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.I2CB.GDTP._CRS.RBUF */
            }
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("3cdff6f7-4267-4555-ad05-b30a3d8938de") /* HID I2C Device */))
                {
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (One)
                        {
                            Return (HID2) /* \_SB_.I2CB.GDTP.HID2 */
                        }
                        Default
                        {
                            Return (Zero)
        ...
        Device (EC0)
        {
            ...
            Device (BATT)
            {
                ...
                Method (_BIF, 0, NotSerialized)  // _BIF: Battery Information
                {
                    ...
                    BPKG [0x09] = BDNS /* \_SB_.PCI0.SBRG.EC0_.BATT.BDNS */
                    Local0 = (BSNH >> 0x04)
                    If ((Local0 >= 0x0A))
                    {
                        Local0 += 0x41
                    ...
                    BSNS [0x03] = Local0
                    BPKG [0x0A] = BSNS /* \_SB_.PCI0.SBRG.EC0_.BATT.BSNS */
                    ...
                    BPKG [0x0C] = BMNS /* \_SB_.PCI0.SBRG.EC0_.BATT.BMNS */
                ...
                Method (_BST, 0, NotSerialized)  // _BST: Battery Status
                {
                    ...
                    Return (PKG1) /* \_SB_.PCI0.SBRG.EC0_.BATT.PKG1 */
                }
            ...
            {
                M460 ("PLA-ASL-\\_SB.PCI0.LPC0.EC0._Q24 DOCK OFF Start\n", Zero, Zero, Zero, Zero, Zero, Zero)
                P80H = 0xEC24
                CreateWordField (DPTI, Zero, SSZE)
                CreateByteField (DPTI, 0x02, MSID)
                CreateDWordField (DPTI, 0x03, MSDV)
            ...
            Method (_Q25, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                CreateDWordField (DPTI, 0x03, MSDV)
                SSZE = 0x07
                M460 ("PLA-ASL- DC OFF proc DPTC ALIB Call\n", Zero, Zero, Zero, Zero, Zero, Zero)
                MSID = 0x05
                MSDV = 0x4E20
                ALIB (0x0C, DPTI)
                MSID = 0x06
