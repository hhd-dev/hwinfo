...
DefinitionBlock ("", "SSDT", 2, "AMD", "CPMPMF", 0x00000001)
{
    ...
    Scope (\_SB)
    {
        Name (PF0A, 0x9741100A)
        Name (PF3A, 0x97411017)
        Name (PF5A, 0x9741103C)
        Name (PF6A, 0x974110CE)
        Name (PF9A, 0x97411102)
        Name (PFBA, 0x974111BA)
        Name (PFCA, 0x9741124E)
        Name (PFDA, 0x974112E2)
