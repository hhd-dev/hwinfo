...
DefinitionBlock ("", "SSDT", 2, "AMD", "GpMsSsdt", 0x00000001)
{
    ...
    Scope (\_SB.PCI0.GPP5)
    {
        ...
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GPP5._DSD\n", Zero, Zero, Zero, Zero, Zero, Zero)
            Return (Package (0x06)
            {
    ...
    Scope (\_SB.PCI0.GPP5.DEV0)
    {
        ...
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GPP5.DEV0 _RMV\n", Zero, Zero, Zero, Zero, Zero, Zero)
            Return (One)
        }

        Method (_INI, 0, Serialized)  // _INI: Initialize
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GPP5.DEV0._INI\n", Zero, Zero, Zero, Zero, Zero, Zero)
            RPD = (\_SB.PCI0.GPP5._ADR >> 0x10)
            RPF = (\_SB.PCI0.GPP5._ADR & 0xFFFF)
        }

        Method (SD7E, 0, Serialized)
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GPP5.DEV0.SD7E\n", Zero, Zero, Zero, Zero, Zero, Zero)
        ...
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GPP5.DEV0._PS0\n", Zero, Zero, Zero, Zero, Zero, Zero)
            SD7E ()
        }

        Method (_PS3, 0, NotSerialized)  // _PS3: Power State 3
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GPP5.DEV0._PS3\n", Zero, Zero, Zero, Zero, Zero, Zero)
        }

        Method (_DSD, 0, Serialized)  // _DSD: Device-Specific Data
        {
            M460 ("PLA-ASL-\\_SB.PCI0.GPP5.DEV0._DSD\n", Zero, Zero, Zero, Zero, Zero, Zero)
            ...
            Return (PDSD) /* \_SB_.PCI0.GPP5.DEV0._DSD.PDSD */
        }
    }
