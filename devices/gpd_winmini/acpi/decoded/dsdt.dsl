 ...
 *
 * Disassembly of ./encoded/dsdt.dat, Thu Dec 21 18:20:50 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008C7D (35965)
 *     Revision         0x02
 *     Checksum         0x99
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x92300000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x92304000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0x9740FF18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x973FCD18, 0x0D)
    ...
    Scope (_SB.I2CA)
    {
        Device (TPD0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                CreateWordField (RBUF, \_SB.I2CA.TPD0._Y2C._ADR, BADR)  // _ADR: Address
                CreateDWordField (RBUF, \_SB.I2CA.TPD0._Y2C._SPE, BSPD)  // _SPE: Speed
                CreateWordField (RBUF, 0x33, IPIN)
                If (Zero)
                {
                    _HID = "SYNA2393"
                    HID2 = 0x20
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("3cdff6f7-4267-4555-ad05-b30a3d8938de") /* HID I2C Device */))
                {
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (One)
                        {
                            Local0 = HID2 /* \_SB_.I2CA.TPD0.HID2 */
                            Return (Local0)
                        }
                        Default
                        {
    ...
    Scope (_SB.I2CB)
    {
        Device (TPL1)
        {
            Name (_HID, "ILTP7807")  // _HID: Hardware ID
            Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
            Name (_UID, Zero)  // _UID: Unique ID
            Name (_S0W, 0x03)  // _S0W: S0 Device Wake State
            Name (HID2, Zero)
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.I2CB.TPL1._CRS.RBUF */
            }
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("3cdff6f7-4267-4555-ad05-b30a3d8938de") /* HID I2C Device */))
                {
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (One)
                        {
                            Return (HID2) /* \_SB_.I2CB.TPL1.HID2 */
                        }
                        Default
                        {
                            Return (Zero)
    ...
    Scope (_SB.PCI0.SBRG)
    {
        ...
        Device (EC0)
        {
            ...
            Device (BAT0)
            {
                ...
                Name (BDNS, Buffer (0x0E)
                {
                    /* 0000 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00               // ......
                })
                Name (BMNS, Buffer (0x0E)
                {
                    /* 0000 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00               // ......
                })
                Name (BCTS, Buffer (0x05)
                {
                ...
                {
                    BPKG [One] = ((B1DC * B1DV) / 0x03E8)
                    BPKG [0x02] = ((B1FC * B1DV) / 0x03E8)
                    BPKG [0x04] = B1DV /* \_SB_.PCI0.SBRG.EC0_.B1DV */
                    If (B1FC)
                    {
                        Local0 = ((B1FC * B1DV) / 0x03E8)
                        Local1 = ((B1DC * B1DV) / 0x03E8)
                        BPKG [0x05] = (Local0 / 0x0A)
                        BPKG [0x06] = (Local0 / 0x14)
                        BPKG [0x07] = (Local1 / 0x64)
                        BPKG [0x08] = (Local1 / 0x32)
                    }

                    BDNS [Zero] = BDN1 /* \_SB_.PCI0.SBRG.EC0_.BDN1 */
                    BDNS [One] = BDN2 /* \_SB_.PCI0.SBRG.EC0_.BDN2 */
                    BDNS [0x02] = BDN3 /* \_SB_.PCI0.SBRG.EC0_.BDN3 */
                    BDNS [0x03] = BDN4 /* \_SB_.PCI0.SBRG.EC0_.BDN4 */
                    BDNS [0x04] = BDN5 /* \_SB_.PCI0.SBRG.EC0_.BDN5 */
                    BDNS [0x05] = BDN6 /* \_SB_.PCI0.SBRG.EC0_.BDN6 */
                    BDNS [0x06] = BDN7 /* \_SB_.PCI0.SBRG.EC0_.BDN7 */
                    BDNS [0x07] = BDN8 /* \_SB_.PCI0.SBRG.EC0_.BDN8 */
                    BDNS [0x08] = BDN9 /* \_SB_.PCI0.SBRG.EC0_.BDN9 */
                    BDNS [0x09] = BDNA /* \_SB_.PCI0.SBRG.EC0_.BDNA */
                    BDNS [0x0A] = BDNB /* \_SB_.PCI0.SBRG.EC0_.BDNB */
                    BDNS [0x0B] = BDNC /* \_SB_.PCI0.SBRG.EC0_.BDNC */
                    BDNS [0x0C] = BDND /* \_SB_.PCI0.SBRG.EC0_.BDND */
                    BDNS [0x0D] = BDNE /* \_SB_.PCI0.SBRG.EC0_.BDNE */
                    BPKG [0x09] = BDNS /* \_SB_.PCI0.SBRG.EC0_.BAT0.BDNS */
                    Local0 = (BSNH >> 0x04)
                    If ((Local0 >= 0x0A))
                    {
                        Local0 += 0x41
                    ...
                    BSNS [0x03] = Local0
                    BPKG [0x0A] = BSNS /* \_SB_.PCI0.SBRG.EC0_.BAT0.BSNS */
                    BCTS [Zero] = BCT1 /* \_SB_.PCI0.SBRG.EC0_.BCT1 */
                    BCTS [One] = BCT2 /* \_SB_.PCI0.SBRG.EC0_.BCT2 */
                    BCTS [0x02] = BCT3 /* \_SB_.PCI0.SBRG.EC0_.BCT3 */
                    BCTS [0x03] = BCT4 /* \_SB_.PCI0.SBRG.EC0_.BCT4 */
                    BCTS [0x04] = BCT5 /* \_SB_.PCI0.SBRG.EC0_.BCT5 */
                    BMNS [Zero] = BMN1 /* \_SB_.PCI0.SBRG.EC0_.BMN1 */
                    BMNS [One] = BMN2 /* \_SB_.PCI0.SBRG.EC0_.BMN2 */
                    BMNS [0x02] = BMN3 /* \_SB_.PCI0.SBRG.EC0_.BMN3 */
                    BMNS [0x03] = BMN4 /* \_SB_.PCI0.SBRG.EC0_.BMN4 */
                    BMNS [0x04] = BMN5 /* \_SB_.PCI0.SBRG.EC0_.BMN5 */
                    BMNS [0x05] = BMN6 /* \_SB_.PCI0.SBRG.EC0_.BMN6 */
                    BMNS [0x06] = BMN7 /* \_SB_.PCI0.SBRG.EC0_.BMN7 */
                    BMNS [0x07] = BMN8 /* \_SB_.PCI0.SBRG.EC0_.BMN8 */
                    BMNS [0x08] = BMN9 /* \_SB_.PCI0.SBRG.EC0_.BMN9 */
                    BMNS [0x09] = BMNA /* \_SB_.PCI0.SBRG.EC0_.BMNA */
                    BMNS [0x0A] = BMNB /* \_SB_.PCI0.SBRG.EC0_.BMNB */
                    BMNS [0x0B] = BMNC /* \_SB_.PCI0.SBRG.EC0_.BMNC */
                    BMNS [0x0C] = BMND /* \_SB_.PCI0.SBRG.EC0_.BMND */
                    BMNS [0x0D] = BMNE /* \_SB_.PCI0.SBRG.EC0_.BMNE */
                    BPKG [0x0C] = BMNS /* \_SB_.PCI0.SBRG.EC0_.BAT0.BMNS */
                    Return (BPKG) /* \_SB_.PCI0.SBRG.EC0_.BAT0.BPKG */
                }
                ...
                Method (_BST, 0, NotSerialized)  // _BST: Battery Status
                {
                    ...
                    PKG1 [0x02] = Local0
                    PKG1 [0x03] = B1PV /* \_SB_.PCI0.SBRG.EC0_.B1PV */
                    Return (PKG1) /* \_SB_.PCI0.SBRG.EC0_.BAT0.PKG1 */
                }
