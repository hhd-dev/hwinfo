 ...
 *
 * Disassembly of ./encoded/ssdt26.dat, Thu Dec 21 18:20:50 2023
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001722 (5922)
 *     Revision         0x02
 *     Checksum         0x2C
 *     OEM ID           "AMD"
 *     OEM Table ID     "UPEP"
...
DefinitionBlock ("", "SSDT", 2, "AMD", "UPEP", 0x00000001)
{
    ...
    External (_SB_.PCI0.SBRG.EC0_.ECHK, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.SBRG.EC0_.GMHD, IntObj)
    External (_SB_.PCI0.SBRG.EC0_.OSTS, IntObj)
    ...
    Scope (\_SB)
    {
        Device (PEP)
        {
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                ...
                {
                    If (CondRefOf (\_SB.PCI0.SBRG.EC0.ECHK))
                    {
                        \_SB.PCI0.SBRG.EC0.ECHK (ToInteger (Arg2))
                    }
