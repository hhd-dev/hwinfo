 ...
 *
 * Disassembly of ./encoded/ssdt6.dat, Wed Feb 21 17:42:20 2024
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000013E4 (5092)
 *     Revision         0x02
 *     Checksum         0xDD
 *     OEM ID           "AMD"
 *     OEM Table ID     "CPMPMF"
...
DefinitionBlock ("", "SSDT", 2, "AMD", "CPMPMF", 0x00000001)
{
    ...
    Scope (\_SB)
    {
        Name (PF0A, 0x96D30FCA)
        Name (PF3A, 0x96D30FD7)
        Name (PF5A, 0x96D30FFC)
        Name (PF6A, 0x96D3108E)
        Name (PF9A, 0x96D310C2)
        Name (PFBA, 0x96D3117A)
        Name (PFCA, 0x96D3120E)
        Name (PFDA, 0x96D312A2)
