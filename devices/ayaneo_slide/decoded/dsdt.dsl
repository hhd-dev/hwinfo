 ...
 *
 * Disassembly of ./encoded/dsdt.dat, Wed Feb 21 17:42:20 2024
 *
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x91C25000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x91C29000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0x96D2CF18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x96D19D18, 0x0D)
    ...
    Scope (_SB.I2CB)
    {
        Device (ACC)
        {
            ...
            Method (ROTM, 0, NotSerialized)
            {
                ...
                Return (SBUF) /* \_SB_.I2CB.ACC_.ROTM.SBUF */
            }
