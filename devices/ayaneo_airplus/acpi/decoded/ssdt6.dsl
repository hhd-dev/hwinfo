 ...
 *
 * Disassembly of ./encoded/ssdt6.dat, Sat Jan 27 17:20:26 2024
 *
...
DefinitionBlock ("", "SSDT", 1, "AMD", "AmdTable", 0x00000001)
{
    ...
    Scope (\_SB)
    {
        Name (PF0A, 0x99453C79)
        Name (PF3A, 0x99453C86)
        Name (PF5A, 0x99453CAB)
        Name (PF6A, 0x99453D3D)
        Name (PF9A, 0x99453D71)
        Name (PFBA, 0x99453E29)
        Name (PFCA, 0x99453EBD)
        Name (PFDA, 0x99453F51)
