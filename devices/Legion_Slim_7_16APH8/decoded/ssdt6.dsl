 ...
 *
 * Disassembly of ./encoded/ssdt6.dat, Tue Feb 20 19:59:04 2024
 *
        ...
        Device (TPM2)
        {
            ...
            Name (_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
            {
                Memory32Fixed (ReadWrite,
                    0x72E82000,         // Address Base
                    0x00004000,         // Address Length
                    )
                Memory32Fixed (ReadWrite,
                    0x72E86000,         // Address Base
                    0x00004000,         // Address Length
                    )
            })
            ...
            OperationRegion (TNVS, SystemMemory, 0x7AE68000, 0x27)
            ...
            OperationRegion (CONA, SystemMemory, 0x7AE68027, 0x30)
