 ...
 *
 * Disassembly of ./encoded/ssdt23.dat, Tue Feb 20 19:59:04 2024
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000014EF (5359)
 *     Revision         0x02
 *     Checksum         0x6F
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    External (_SB_.PCI0.LPC0.EC0_.CSRM, FieldUnitObj)
    External (_SB_.PCI0.LPC0.EC0_.CSST, FieldUnitObj)
    External (_SB_.PCI0.LPC0.EC0_.ECRD, FieldUnitObj)
    External (_SB_.PCI0.LPC0.EC0_.RTCB, MethodObj)    // 2 Arguments
    External (_SB_.PCI0.LPC0.EC0_.SCMS, FieldUnitObj)
    External (_SB_.PCI0.LPC0.EC0_.SPWM, FieldUnitObj)
                ...
                ElseIf ((Arg0 == ToUUID ("11e00d56-ce64-47ce-837b-1f898f9aa461") /* Unknown UUID */))
                {
                    Switch (ToInteger (Arg2))
                    {
                        ...
                        Case (0x04)
                        {
                            ...
                            M000 (0x3E04)
                            M460 ("    Return (0x00)\n", Zero, Zero, Zero, Zero, Zero, Zero)
                            \_SB.PCI0.LPC0.EC0.RTCB (FromBCD (M034 (0x02)), FromBCD (M034 (0x04)))
