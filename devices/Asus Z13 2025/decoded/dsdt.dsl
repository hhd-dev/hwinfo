...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Name (MBB, 0x80000000)
            Name (MBL, 0x60000000)
            Name (MAB, 0x0000000890000000)
            Name (MAL, 0x0000007770000000)
            Name (MAM, 0x0000007FFFFFFFFF)
            Name (NRSB, 0x71366000)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0x71365000, 0x0100)
    ...
    Scope (_SB)
    {
        OperationRegion (ASRO, SystemMemory, ASRB, 0x07)
    ...
    Scope (_TZ)
    {
        ...
        Method (RTMP, 0, NotSerialized)
        {
            If (\_SB.PCI0.SBRG.EC0.ECAV ())
            {
                ...
                Local0 = \_SB.PCI0.SBRG.EC0.RBNM (0x98)
        ...
        Method (RCRT, 0, NotSerialized)
        {
            ...
            {
                Acquire (\_SB.PCI0.SBRG.EC0.CMUT, 0xFFFF)
                Local0 = \_SB.PCI0.SBRG.EC0.RBNM (0x99)
                Release (\_SB.PCI0.SBRG.EC0.CMUT)
                If ((Local0 < 0x80))
                {
                    \_SB.TCRT = Local0
        ...
        Method (RPSV, 0, NotSerialized)
        {
            ...
            {
                Acquire (\_SB.PCI0.SBRG.EC0.CMUT, 0xFFFF)
                Local0 = \_SB.PCI0.SBRG.EC0.RBNM (0x9A)
                Release (\_SB.PCI0.SBRG.EC0.CMUT)
                If ((Local0 < 0x80))
                {
                    \_SB.TPSV = Local0
        ...
        Device (ATKD)
        {
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))
                {
                    ...
                    If ((IIA0 == 0x00120063))
                    {
                        Local0 = ^^PCI0.SBRG.EC0.REBC (0x36, One)
                        Local1 = DerefOf (Local0 [Zero])
                        If ((Local1 == One))
                        {
                            Return (0x00010000)
                    ...
                    If ((IIA0 == 0x0011001D))
                    {
                        Local0 = ^^PCI0.SBRG.EC0.REBC (0x3A, One)
                        Local1 = DerefOf (Local0 [Zero])
                        Local1 |= 0x00010000
                        Return (Local1)
                    }
                    ...
                    If ((IIA0 == 0x00120094))
                    {
                        ...
                        {
                            Acquire (^^PCI0.SBRG.EC0.CMUT, 0xFFFF)
                            Local0 = ^^PCI0.SBRG.EC0.RBNM (0x98)
                            Release (^^PCI0.SBRG.EC0.CMUT)
                            Local0 |= 0x00010000
                            Return (Local0)
                        }
    ...
    Scope (_SB.I2CD)
    {
        Device (SHUB)
        {
            ...
            Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
            Name (_UID, One)  // _UID: Unique ID
            Name (_HID, "ITE8353")  // _HID: Hardware ID
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (0x0F)
            }
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBFI) /* \_SB_.I2CD.SHUB._CRS.SBFI */
            }
        }
    }
    ...
    Scope (_SB.I2CB)
    {
        Device (SPKR)
        {
            ...
            Name (_SUB, "10431FB3")  // _SUB: Subsystem ID
            Name (_UID, One)  // _UID: Unique ID
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
