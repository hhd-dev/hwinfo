 ...
 *
 * Disassembly of ./encoded/ssdt15.dat
 *
...
DefinitionBlock ("", "SSDT", 2, "AMD", "CPMMSOSC", 0x00000001)
{
    ...
    External (PSIG, FieldUnitObj)
    External (PWOC, FieldUnitObj)
        ...
        Method (_OSC, 4, Serialized)  // _OSC: Operating System Capabilities
        {
            ...
            If ((Arg0 == ToUUID ("23a0d13a-26ab-486c-9c5f-0ffa525a575a") /* USB4 Capabilities */))
            {
                If ((Arg1 == One))
                {
                    ...
                    {
                        If (((M049 (M620, 0x10) != Zero) && (M046 >= 0x0B)))
                        {
                            If ((\_SB.M630 == 0x5555))
                            {
