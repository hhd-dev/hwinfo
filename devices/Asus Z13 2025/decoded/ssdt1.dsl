...
DefinitionBlock ("", "SSDT", 2, "AMD", "AmdTable", 0x00000002)
{
    Scope (\_SB)
    {
        ...
        Name (ADAT, Buffer (0x0520)
        {
            ...
            /* 0028 */  0x1B, 0xFF, 0xFF, 0x00, 0x00, 0x02, 0x05, 0x00,  // ........
            ...
            /* 0050 */  0x15, 0xFF, 0xFF, 0x02, 0x00, 0x02, 0x02, 0x00,  // ........
        ...
        BankField (A154, A155, 0x03B10928, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A153,   32
        }

        BankField (A154, A155, 0x03B10978, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A146,   32
        }
        ...
        BankField (A154, A155, 0x0C910954, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A171,   32
        }
        ...
        {
            Acquire (\_SB.AM00, 0xFFFF)
            CreateDWordField (Arg1, 0x00, A158)
            CreateDWordField (Arg1, 0x04, A159)
            CreateDWordField (Arg1, 0x08, A160)
            CreateDWordField (Arg1, 0x0C, A161)
            CreateDWordField (Arg1, 0x10, A162)
            CreateDWordField (Arg1, 0x14, A163)
            Local0 = (0x80000000 & A164) /* \_SB_.A164 */
            While ((Local0 == 0x00))
            {
                Local0 = (0x80000000 & A164) /* \_SB_.A164 */
            }
            ...
            A167 = A160 /* \_SB_.A046.A160 */
            A168 = A161 /* \_SB_.A046.A161 */
            A169 = A162 /* \_SB_.A046.A162 */
            A170 = A163 /* \_SB_.A046.A163 */
            Local1 = (Arg0 & 0xFF)
            Local1 <<= 0x08
            A164 = Local1
            A171 = 0xFFFFFFFF
