    ...
    Scope (\_SB.PCI0.GPPA.VGA)
    {
        ...
        Method (ATPX, 2, Serialized)
        {
            ...
            If ((Arg0 == 0x02))
            {
                ...
                Return (M189) /* \_SB_.PCI0.GPPA.VGA_.M189 */
            }
        ...
        Method (PX08, 0, NotSerialized)
        {
            ...
            M193 = Local0
            M157 = 0x05
            Local0 *= M157 /* \_SB_.PCI0.GPPA.VGA_.PX08.M157 */
            Local1 = Zero
            While ((Local1 < Local0))
            {
        ...
        Method (PX09, 0, NotSerialized)
        {
            ...
            M193 = Local0
            M157 = 0x03
            Local0 *= M157 /* \_SB_.PCI0.GPPA.VGA_.PX09.M157 */
            Local1 = Zero
            While ((Local1 < Local0))
            {
        ...
        Method (PX11, 1, NotSerialized)
        {
            ...
            M157 = 0x03
            M162 = (Arg0 & One)
            Local2 = M162 /* \_SB_.PCI0.GPPA.VGA_.PX11.M162 */
        ...
        Method (ATIF, 2, Serialized)
        {
            ...
            M159 = Zero
            M160 = Zero
            Return (ATIB) /* \_SB_.PCI0.GPPA.VGA_.ATIB */
        }
        ...
        Method (AF02, 0, NotSerialized)
        {
            ...
            ATIB = Zero
            M157 = 0x12
            M174 = M164 /* \_SB_.PCI0.GPPA.VGA_.M164 */
            If (M165)
            {
                M165 = Zero
            }
            ...
            If (M166)
            {
                M175 = M210 /* \_SB_.PCI0.GPPA.VGA_.M210 */
                M210 = Zero
                M166 = Zero
            }
            ...
            If (M167)
            {
                M176 = M211 /* \_SB_.PCI0.GPPA.VGA_.M211 */
                M177 = M212 /* \_SB_.PCI0.GPPA.VGA_.M212 */
                M211 = Zero
                M212 = Zero
                M167 = Zero
            }
            ...
            If (M168)
            {
                M178 = M213 /* \_SB_.PCI0.GPPA.VGA_.M213 */
                M179 = M214 /* \_SB_.PCI0.GPPA.VGA_.M214 */
                M213 = Zero
                M214 = Zero
                M168 = Zero
            }
            ...
            If (M169)
            {
                M180 = M215 /* \_SB_.PCI0.GPPA.VGA_.M215 */
                M169 = Zero
            }
            ...
            If (M300)
            {
                M301 = M303 /* \_SB_.PCI0.GPPA.VGA_.M303 */
                M302 = M304 /* \_SB_.PCI0.GPPA.VGA_.M304 */
                M303 = Zero
                M304 = Zero
                M300 = Zero
            }
        ...
        Method (AF03, 2, NotSerialized)
        {
            ...
            Local1 = M182 /* \_SB_.PCI0.GPPA.VGA_.AF03.M182 */
            Local1 &= 0x8B
            Local2 = M183 /* \_SB_.PCI0.GPPA.VGA_.AF03.M183 */
            If (CondRefOf (\_SB.LID._LID))
            {
                Local0 = \_SB.LID._LID ()
            ...
            While ((Local0 < M187))
            {
                ...
                {
                    M185 = Local0
                    Local0 = M187 /* \_SB_.PCI0.GPPA.VGA_.AF03.M187 */
                }
                Else
                {
                    Local0++
            ...
            Local0 = M185 /* \_SB_.PCI0.GPPA.VGA_.AF03.M185 */
            While ((Local0 < M187))
            {
                Local0++
                If ((Local0 == M187))
            ...
            Else
            {
                Local0 = M184 /* \_SB_.PCI0.GPPA.VGA_.AF03.M184 */
                Local3 = DerefOf (M186 [Local0])
        ...
        Method (AFN4, 1, Serialized)
        {
            ...
            {
                Local0 = Arg0
                Local1 = M215 /* \_SB_.PCI0.GPPA.VGA_.M215 */
                M215 = Local0
                If ((Local0 != Local1))
                {
                    CreateBitField (M164, 0x04, M169)
