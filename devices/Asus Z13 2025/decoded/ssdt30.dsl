 ...
 *
 * Disassembly of ./encoded/ssdt30.dat
 *
...
DefinitionBlock ("", "SSDT", 2, "AMD", "WLAN", 0x00000001)
{
    ...
    Scope (\_SB.PCI0.GPP5)
    {
        ...
        {
            Local0 = 0x04
            M460 ("PLA-ASL-\\_SB.PCI0.GPP5._S0W : %x\n", Local0, Zero, Zero, Zero, Zero, Zero)
            Return (Local0)
        }
        ...
        PowerResource (PWRS, 0x00, 0x0000)
        {
            ...
            {
                M000 (0x34AA)
                M460 ("PLA-ASL-_SB.PCI0.GPP5.PWRS._STA\n", Zero, Zero, Zero, Zero, Zero, Zero)
                Return (PSTA) /* \_SB_.PCI0.GPP5.PWRS.PSTA */
            }

            Method (_ON, 0, Serialized)  // _ON_: Power On
            {
                M000 (0x34D0)
                M460 ("PLA-ASL-_SB.PCI0.GPP5.PWRS._ON\n", Zero, Zero, Zero, Zero, Zero, Zero)
                If ((PSTA != One))
                {
                    If (CondRefOf (\WLD3))
                    {
            ...
            {
                M000 (0x34D3)
                M460 ("PLA-ASL-_SB.PCI0.GPP5.PWRS._OFF\n", Zero, Zero, Zero, Zero, Zero, Zero)
                If ((PSTA != Zero))
                {
                    If (CondRefOf (\WLD3))
                    {
    ...
    Scope (\_SB.PCI0.GPP5.WLAN)
    {
        ...
        Method (_S0W, 0, NotSerialized)  // _S0W: S0 Device Wake State
        {
            ...
            M460 ("PLA-ASL-\\_SB.PCI0.GPP5.WLAN._S0W : %x\n", Local0, Zero, Zero, Zero, Zero, Zero)
            Return (Local0)
        }
